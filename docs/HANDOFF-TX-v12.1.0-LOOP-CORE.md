...
- Patch change: **v12.1.1**
  - ストーリー/物語解説の太字を軽量化した。
  - `.fa-narrative b` は `font-weight:560` 以下。700系の太字へ戻さない。
...
- 物語解説の強調語は色で目を止める。`.fa-narrative b` は `font-weight:560` 以下にし、iPhoneで潰れる黒い塊にしない。
...
```text
TX/TXLEX は v12.1.1 LOOP-CORE を現行正典として生成してください。
...
物語解説の強調太字は軽くしてください。.fa-narrative b は font-weight:560 以下を正典値とし、600超や700系へ戻さないでください。
