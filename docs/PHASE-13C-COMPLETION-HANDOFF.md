...
**problems/305.json + render.py → outputs/000_TX/001_刑法/刑TX305.html (171,375 bytes)**
...
$density_html = python scripts\measure_density_v2.py outputs\000_TX\${jp}TX\${jp}TX$pid.html | Select-String "total"
...
python scripts\validate-tx.py outputs\000_TX\001_刑法\刑TX304.html
# → ERROR 0 / WARNING 0 確認
python scripts\measure_density_v2.py outputs\000_TX\001_刑法\刑TX304.html
# → 全 5 件 PASS 確認

# 視覚 sanity（feature-tag 33 件 / theory-detail-grid 等）
grep -c "feature-tag" outputs\000_TX\001_刑法\刑TX304.html
# 期待: 33

# 判定 OK なら _experimental に baseline 統一
cp outputs\000_TX\001_刑法\刑TX304.html _experimental\刑TX304.html
