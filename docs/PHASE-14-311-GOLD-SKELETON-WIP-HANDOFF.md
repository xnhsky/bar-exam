...
- これを `outputs/tx/刑TX/刑TX311.html` にコピーして作業継続
...
```powershell
# 1. WIP を outputs に復元
cp _experimental/刑TX311-wip-gold-skeleton.html outputs/tx/刑TX/刑TX311.html

# 2. 現状確認
wc -l outputs/tx/刑TX/刑TX311.html  # 4210行のはず
grep -n 'id="choice-' outputs/tx/刑TX/刑TX311.html  # choice-1, 2 が 311 / choice-3,4,5 が 303
