...
| 項目 | 値 |
|---|---|
| 出力先ディレクトリ | `outputs/000_TX/007_憲法/` |
...
| ⑤ | `render.py` で KEN001 生成 | `outputs/000_TX/007_憲法/憲TX001.html` 出力 | - | render exit 0 |
...
- [x] 命名規約確定 (`outputs/000_TX/007_憲法/憲TX{NNN}.html`, `problems/KEN{NNN}.json`)
