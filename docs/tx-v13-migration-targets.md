...
| **非特殊 v11 backlog** | 28→27 | 401(済) 402-445 の非特殊 | **決定論ラッパー `tx-lex-v11-to-v13.py`** | **不要**（既存 v11 本文が素材） |
| 正誤表リデザイン待ち | 2 | 360 420 | verdict-redesign（上記26本リスト） | 不要 |

- **401 完了（2026-07-07・リモートパイロット）**：`tx-lex-v11-to-v13.py` で v13.1.0 化。国家的法益
