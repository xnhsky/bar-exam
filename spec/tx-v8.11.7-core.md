# TX v8.11.7 完全統合自己完結仕様書

**KTX301-canonical · readability-enhanced · hanging-indent-grid · lessons-from-chat-002 · single-document-self-sufficient · jp-prefix-naming · content-independence · a2-two-stage-reveal · 3-type-support · spoiler-leak-eradication · spoiler-strong-elimination · ox-grid-fa-unification · host-injection-safe**
...
## §33. footer-spec canonical（v8.11.7 版）
...
- `TX v8.11.7`（**改訂**：v8.11.1 → v8.11.7、v8.11.2〜v8.11.6 機能を一括統合）
...
## §Annex A. Canonical CSS（KTX301 byte-level 逐語）
...
/* ============================================================
   TX v8.7 - P1 ローズシャンブル
   KTX301 司法試験R1-16 詐欺罪と他罪の成否 / 正答率 65%
   ============================================================ */
...
/* ============================================================
   §24 SIMPLE READABILITY ENHANCEMENTS  (light touch)
   - h3 subheadings: more visible
   - alternating backgrounds for cross-card / memory-item
   ============================================================ */
...
/* §24-3  Alternating backgrounds — C-7 memory-item (within each list, by priority) */
.memory-list .memory-item.priority-a:nth-of-type(even),
.memory-list .memory-item.priority-b:nth-of-type(even),
...
/* §24-5  日本国語的字下げ — 本文段落すべて (見出し・キャプション類は除外) */
p{
  text-indent:1em;
}
/* 除外：キャプション・短い指示文・タブ等のラベル的 p */
.figure-caption,
.answer-instruction{
  text-indent:0;
}
...
/* §24-6  ハンギングインデント — grid 2-column (ラベル列 + 本文列) */
.basis-card-body > p.hanging{
  display:grid;
  grid-template-columns:max-content 1fr;
  column-gap:.5em;
...
.basis-card-body > p.hanging > .hang-body{
  /* body column — preserves inline flow for nested spans */
  display:block;
}
...
## §Annex B. Canonical Body Skeleton（KTX301 byte-level 逐語）

`<body id="top">` 〜 `</body>` までを逐語コピー。**A-3 共通根拠 section が PART B の後ろ・PART C の前に配置**されている KTX301 v8.11.0 構造を含む。本文中の問題コンテンツ（KTX301 の刑法詐欺罪事案）は §0-tri STEP 3 でターゲット問題のコンテンツに差替える：
...
<div class="container">
  ...
  <!-- ============================================================
       HEADER（answer leak 禁止 §7-3）
       ============================================================ -->
  <header class="header">
    <div class="doc-header">KTX301</div>
    <div class="header-top">
      <span class="exam-badge">📚 刑法</span>
      <span class="exam-badge">📝 司法試験</span>
      <span class="exam-badge">📅 令和元年</span>
      <span class="exam-badge">🔢 第16問</span>
    </div>
    <h1>No.301 ── 詐欺罪と他罪の成否（司法試験R1-16）</h1>
    <div class="theme-tags">
      <span class="theme-tag">詐欺罪（246条）</span>
      <span class="theme-tag">背任罪（247条）</span>
      <span class="theme-tag">恐喝罪（249条）</span>
      <span class="theme-tag">業務上横領罪（253条）</span>
      <span class="theme-tag">放火罪（109条）</span>
      <span class="theme-tag">偽造通貨行使罪（148条2項）</span>
      <span class="theme-tag">罪数論・法条競合</span>
      <span class="theme-tag">実行の着手</span>
    </div>
    <div class="exam-meta">
      <span><strong>正答率:</strong>65%</span>
      <span><strong>難度:</strong>★★☆</span>
      <span><strong>パターン:</strong>P1 ローズシャンブル</span>
    </div>
    <div class="toc-row">
      <a href="#part-a">問題文</a>
      <a href="#answer-area">解答</a>
  ...
  <section class="section" id="part-a">
    ...
    <p style="font-weight:600;">
      次のアからオまでの各<strong>【記述】</strong>を判例の立場に従って検討した場合、後記の各<strong>【結論】</strong>との組合せとして<span class="exam-mark freq-high">正しいもの</span>は、後記1から5までのうちどれか。なお、【結論】の詐欺罪には詐欺未遂罪も含むものとする。
    </p>
    ...
    <div class="problem-text"><span class="choice-num-inline">ア</span>他人のためにその事務を処理する者が、任務に背いて、その他人を欺く行為をし、同人を錯誤に陥らせて財物を交付させた。</div>
    <div class="problem-text"><span class="choice-num-inline">イ</span>他人を恐喝するに際して、脅迫文言の中に虚偽の部分があり、それも同人に畏怖の念を生じさせる一材料となって、その畏怖の結果として、同人に財物を交付させた。</div>
    <div class="problem-text"><span class="choice-num-inline">ウ</span>新聞販売店から集金業務を委託されている集金員が、集金した購読料を同店に持ち帰らずに自己の用途に費消するつもりであるのに、これを秘して、正規の手続や方式に従って購読者から購読料を集金し、自己の遊興費に費消した。</div>
    <div class="problem-text"><span class="choice-num-inline">エ</span>保険金を詐取する目的で、火災保険の付された自己所有の家屋に放火した。</div>
    <div class="problem-text"><span class="choice-num-inline">オ</span>他人に売買代金として偽造通貨を行使し、同人を錯誤に陥らせて財物を交付させた。</div>

    <h3 style="background:transparent; border-left:none; padding:8px 0 4px 0; margin:24px 0 8px 0; border-bottom:2px dotted var(--border-mid); color:var(--accent); font-family:var(--font-display);">【結論】</h3>
    <div class="basis-card statute-card">
      <div class="basis-card-body">
        <p class="hanging"><strong>I.</strong><span class="hang-body">　詐欺罪のみが成立し得る。</span></p>
        <p class="hanging"><strong>II.</strong><span class="hang-body">　詐欺罪と他の罪の双方が成立し得る。</span></p>
        <p class="hanging"><strong>III.</strong><span class="hang-body">　詐欺罪は成立しない。</span></p>
      </div>
    </div>

    <h3 style="background:transparent; border-left:none; padding:8px 0 4px 0; margin:24px 0 8px 0; border-bottom:2px dotted var(--border-mid); color:var(--accent); font-family:var(--font-display);">【選択肢】</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th style="width:80px;">肢</th><th>組合せ</th></tr>
        </thead>
        <tbody>
          <tr><td><strong>1</strong></td><td>アⅠ ─ イⅡ</td></tr>
          <tr><td><strong>2</strong></td><td>アⅡ ─ ウⅢ</td></tr>
          <tr><td><strong>3</strong></td><td>イⅢ ─ エⅢ</td></tr>
          <tr><td><strong>4</strong></td><td>ウⅡ ─ オⅡ</td></tr>
          <tr><td><strong>5</strong></td><td>エⅡ ─ オⅢ</td></tr>
        </tbody>
      </table>
    </div>
  ...
  <section class="section" id="answer-area">
    ...
    <div class="answer-area"
         data-correct-value="3"
         data-explanation="3。各記述の判例による分類は、ア＝Ⅰ（背任行為は詐欺罪に包含。最判昭28.5.8）／イ＝Ⅲ（畏怖の一材料に過ぎず恐喝罪。最判昭24.2.8）／ウ＝Ⅲ（適法な集金後の費消＝業務上横領罪、集金自体は詐欺ではない。東京高判昭28.6.12）／エ＝Ⅲ（放火だけでは詐欺の実行着手なし。大判明5.12.12）／オ＝Ⅲ（偽造通貨行使罪に包含され詐欺罪は別途成立しない。大判明43.6.30）。正しい組合せは『イⅢ─エⅢ』＝肢3。">
      <h3>正しい組合せの番号をクリック</h3>
  ...
  <!-- ============================================================
       PART B ── 肢別解説（記述ア〜オの判例上の分類）
       ============================================================ -->
  <div class="part-title">PART B ── 記述別解説（ア〜オ）</div>
  ...
  <section class="choice-section odd" id="choice-1">
    ...
    <div class="choice-header-block">
      ...
      <span class="verdict verdict-correct">→ 結論Ⅰ 詐欺罪のみが成立し得る</span>
      <div class="choice-summary">背任行為が同時に詐欺の欺罔行為に当たる場合、判例は背任罪を別個に構成せず、詐欺罪のみが成立する</div>
    </div>

    <div class="sub-card original">
      <span class="label">記述原文</span>
      <p>他人のためにその事務を処理する者が、任務に背いて、その他人を欺く行為をし、同人を錯誤に陥らせて財物を交付させた。</p>
    </div>

    <div class="sub-card explanation">
      <h4>📖 解説原文</h4>
      <p><a class="ref-case" id="ref-case-saiko-s28-5-8-001" href="#case-saiko-s28-5-8">最判昭28.5.8</a>は、「他人の委託によりその事務を処理する者が、その事務処理上任務に背き本人に対し欺罔行為を行い同人を錯誤に陥れ、よつて財物を交付せしめた場合には<span class="exam-mark freq-high">詐欺罪を構成し、たとい背任罪の成立要件を具備する場合でも別に背任罪を構成するものではない</span>」としている。判例に賛成する学説は、理由として、背任行為は詐欺罪の観念に当然に包含されるから、別に背任罪を構成するものではないということを挙げる。したがって、アの記述では<span class="case-emphasis freq-high">詐欺罪のみが成立し得る</span>（結論Ⅰ）。</p>
    </div>

    <div class="sub-card basis-link">
      <h4>📚 根拠条文・判例</h4>
      <div class="back-link-row">
        <a class="back-link" href="#law-246">→ 246条1項（詐欺）</a>
        <a class="back-link" href="#law-247">→ 247条（背任）</a>
        <a class="back-link" href="#case-saiko-s28-5-8">→ 最判昭28.5.8</a>
      </div>
      <p style="font-size:.92em; margin-top:6px;">背任行為が詐欺罪に当然包含される＝法条競合・吸収関係の典型事例。</p>
    </div>
    ...
    <div class="sub-card professor">
      ...
      <p>要するに、<strong>背任行為と欺罔行為が同一の事実関係で重なる場合、詐欺罪と背任罪の両方が成立するのか、それとも詐欺罪のみか</strong>、を聞いています。<a class="ref-stat" id="ref-law-247-001" href="#law-247">247条</a>と<a class="ref-stat" id="ref-law-246-001" href="#law-246">246条1項</a>の<span class="case-emphasis freq-high">罪数関係</span>の問題。</p>

      <div class="prof-heading"><span class="prof-num">2</span>考え方の道筋</div>
      <p>まず、<span class="case-emphasis freq-high">背任罪</span>と<span class="case-emphasis freq-high">詐欺罪</span>の保護法益を確認します。背任罪は「他人の事務処理者が任務に背いて本人に財産上の損害を加える」ことを処罰する罪で、保護法益は<span class="exam-mark freq-mid">本人の財産</span>。詐欺罪も同様に<span class="exam-mark freq-mid">財産</span>を保護法益とする。</p>
      <p>本問では、事務処理者が「任務に背いて」「欺く行為をし」「錯誤に陥らせて」「財物を交付させた」とあります。これは<strong>同一の財産侵害行為が、背任の構成要件と詐欺の構成要件の両方を満たす</strong>場面です。</p>
      <p>判例は、<span class="ron-mark freq-high">背任行為は詐欺罪の観念に当然包含される</span>として、別個に背任罪を構成しないと解します（吸収関係・法条競合の発想）。重い詐欺罪のみが成立し、軽い背任罪は別途構成しない。</p>

      <div class="key-phrase-box">
        背任行為が詐欺罪を満たす場合＝<span class="kp-strong">詐欺罪に当然包含</span>。<br>
        別途<span class="kp-strong">背任罪は構成しない</span>。<a class="ref-stat" href="#law-246">246条</a>のみ成立。
      </div>

      <div class="prof-heading"><span class="prof-num">3</span>イメージで掴む</div>
      <div class="prof-analogy">
        <span class="scene-title">場面：弁護士が依頼人を騙して着服する</span>
        <p>依頼人から訴訟事件の和解金を預かる弁護士が、「裁判所への供託費用が別途必要だ」と<strong>嘘の口実</strong>で依頼人から追加金を受け取り、自分の遊興費に使う。これは依頼人の事務処理者（受任者）として<strong>任務に背いた行為</strong>であり背任の要素を持つが、同時に<strong>嘘で錯誤に陥らせて金員を交付させた</strong>という詐欺の構造そのもの。</p>
        <p>このとき、依頼人が受けた財産侵害は<strong>一つ</strong>──「弁護士に追加金を取られた」という事実だけ。これに対して<strong>詐欺と背任の二つの罪</strong>を被せれば、被害事実1つに対して刑罰が二重にかかってしまう。判例は、<strong>欺罔という重い違法要素を含む詐欺罪が、軽い背任罪を吸収する</strong>と整理する。</p>
        <p>これは「数物店で同じ商品が二枚値札を貼られていたら、原則として一方の値札（重い方）で会計する」のと同じ発想。<strong>同一の侵害事実に二重に値段（刑罰）はつけない</strong>のが法条競合・吸収関係の原則。</p>
      </div>

      <div class="prof-heading"><span class="prof-num">4</span>あてはめ</div>
      <p>本問では、甲は他人の事務処理者であり「任務に背いて」「その他人を欺く行為をし」「錯誤に陥らせて」「財物を交付させた」とあります。これは<a class="ref-stat" id="ref-law-247-002" href="#law-247">247条</a>背任罪の要件（任務違背＋財産損害）と<a class="ref-stat" id="ref-law-246-002" href="#law-246">246条1項</a>詐欺罪の要件（欺罔→錯誤→処分→財物移転）の両方を満たします。</p>
      <p>判例（<a class="ref-case" id="ref-case-saiko-s28-5-8-002" href="#case-saiko-s28-5-8">最判昭28.5.8</a>）の立場では、背任行為が詐欺罪に当然包含されるので、<strong>詐欺罪のみが成立</strong>し、別個に背任罪は成立しません。これは結論<span class="case-emphasis freq-high">Ⅰ「詐欺罪のみが成立し得る」</span>に該当する。</p>

      <div class="warning">
        <p>「背任の要件も詐欺の要件も両方満たすのだから、観念的競合で両方成立する」と考えてはいけません。判例は、両罪を<strong>観念的競合（54条1項前段）</strong>ではなく<span class="case-emphasis freq-high">法条競合・吸収関係</span>として処理する。詐欺罪が背任罪を吸収するため、背任罪は処断刑にすら現れない。</p>
      </div>

      <div class="cross-link">
        <p><strong>罪数論（刑法総論）との接続</strong>：法条競合のうち<span class="exam-mark freq-mid">「吸収関係」</span>の典型例。同一の侵害事実に対し、重い罪が軽い罪を吸収する。観念的競合（同一行為で複数罪）や牽連犯（手段結果関係）とは区別される。本問のような<strong>同一の事実が複数の構成要件に重畳的に該当</strong>する場合の処理として、答案でも頻出する論点。</p>
      </div>
    </div>

    <div class="choice-points">
      <ol>
        <li>背任罪（<a class="ref-stat" href="#law-247">247条</a>）と詐欺罪（<a class="ref-stat" href="#law-246">246条1項</a>）の両方の要件を満たす行為について、判例は<strong>法条競合・吸収関係</strong>と整理。</li>
        <li><a class="ref-case" href="#case-saiko-s28-5-8">最判昭28.5.8</a>：背任行為は<strong>詐欺罪の観念に当然包含</strong>される。重い詐欺罪のみ成立、別途背任罪は構成しない。</li>
        <li>記述アは<strong>結論Ⅰ「詐欺罪のみが成立し得る」</strong>に該当（→ 詐欺罪と背任罪「双方が成立し得る」とする結論Ⅱは誤り）。</li>
      </ol>
    </div>
    <div class="back-to-top"><a href="#top">↑ ページ先頭へ</a></div>
  </section>
  ...
  <section class="choice-section even" id="choice-2">
    ...
    <div class="choice-header-block">
      <div class="choice-big-badge">イ</div>
      <span class="verdict verdict-incorrect">→ 結論Ⅲ 詐欺罪は成立しない</span>
      <div class="choice-summary">虚偽部分が畏怖を生じさせる一材料にすぎず、究極的に畏怖により財物が交付された場合は恐喝罪のみ成立し、詐欺罪は成立しない</div>
    </div>

    <div class="sub-card original">
      <span class="label">記述原文</span>
      <p>他人を恐喝するに際して、脅迫文言の中に虚偽の部分があり、それも同人に畏怖の念を生じさせる一材料となって、その畏怖の結果として、同人に財物を交付させた。</p>
    </div>

    <div class="sub-card explanation">
      <h4>📖 解説原文</h4>
      <p><a class="ref-case" id="ref-case-saiko-s24-2-8-001" href="#case-saiko-s24-2-8">最判昭24.2.8</a>は、「被告人の施用した手段の中に虚偽の部分……があつても、その部分も相手方に畏怖の念を生ぜしめる一材料となり、その畏怖の結果として相手方が財物を交付するに至つた場合は<span class="exam-mark freq-high">詐欺罪ではなく恐喝罪となる</span>」としている。判例に賛成する学説は、理由として、<span class="case-emphasis freq-high">欺罔は相手方を畏怖させるための一材料にすぎず、究極的には恐喝による畏怖の結果として財物が交付されたといえる</span>ことを挙げている。したがって、イの記述では<span class="case-emphasis freq-high">詐欺罪は成立しない</span>（結論Ⅲ）。</p>
    </div>
    ...
    <div class="sub-card basis-link">
      ...
      <div class="back-link-row">
        <a class="back-link" href="#law-246">→ 246条1項（詐欺）</a>
        <a class="back-link" href="#law-249">→ 249条1項（恐喝）</a>
        <a class="back-link" href="#case-saiko-s24-2-8">→ 最判昭24.2.8</a>
      </div>
      <p style="font-size:.92em; margin-top:6px;">財物交付の<strong>究極的原因</strong>が「畏怖」か「錯誤」かで罪名を画する判例。混在事案の処理ルール。</p>
    </div>
    ...
    <div class="sub-card professor">
      ...
      <div class="prof-heading"><span class="prof-num">1</span>ポイント</div>
      <p>要するに、<strong>脅迫の中に嘘が混じり、その嘘も畏怖の一因になって財物が交付された場合、詐欺罪と恐喝罪の双方が成立するのか、それとも一方のみか</strong>、を聞いています。両罪が形式的には重なる事案での<span class="case-emphasis freq-high">処理ルール</span>。</p>

      <div class="prof-heading"><span class="prof-num">2</span>考え方の道筋</div>
      <p><a class="ref-stat" id="ref-law-246-003" href="#law-246">246条1項</a>詐欺罪と<a class="ref-stat" id="ref-law-249-001" href="#law-249">249条1項</a>恐喝罪は、いずれも被害者の<span class="exam-mark freq-mid">処分行為</span>により財物が交付される点で共通する。区別の本質は<strong>処分行為の動機</strong>──錯誤に基づくか、畏怖に基づくか。</p>
      <p>本問のように<span class="case-emphasis freq-high">脅迫文言の中に虚偽が混じる</span>場合、相手方は「畏怖」と「錯誤」の両方を同時に抱きうる。このとき、どちらを基準に罪名を決めるかが問題。</p>
      <p>判例は、<span class="ron-mark freq-high">財物交付の究極的原因が畏怖であれば恐喝罪のみ</span>とする。虚偽が単独で交付を惹起したのではなく、<span class="exam-mark freq-mid">畏怖を強化する「一材料」に過ぎない</span>と評価できる場合、欺罔→錯誤の独立した因果連鎖が成立しないので、詐欺罪は成立しない。</p>

      <div class="key-phrase-box">
        虚偽が<span class="kp-strong">畏怖の一材料</span>に過ぎず、究極的原因が畏怖＝<span class="kp-strong">恐喝罪のみ成立</span>。<br>
        詐欺罪は<span class="kp-strong">独立した欺罔→錯誤→処分</span>の因果連鎖を要する。
      </div>

      <div class="prof-heading"><span class="prof-num">3</span>イメージで掴む</div>
      <div class="prof-analogy">
        <span class="scene-title">場面：脅迫状の中の嘘──ナイフと作り話</span>
        <p>路上で被害者を捕まえ、ナイフを示しながら「俺は組の若頭だ、金を出さないと組員が押しかける」と凄む人物がいる。<strong>「組の若頭」は嘘</strong>──実は無関係の単独犯。被害者は組員が押しかけてくる将来の危害を畏れ、金を渡す。</p>
        <p>このとき、被害者を金を出させたのは<strong>「組員が押しかける」という嘘そのもの</strong>か、それとも<strong>「目の前のナイフ＋直接の暴力の予告」という畏怖</strong>か。よく見ると、嘘がなくてもナイフを示されて凄まれていれば畏怖して金を出すはずだ──<strong>嘘は畏怖を一段強化する「サブ材料」</strong>に過ぎず、究極の原動力は畏怖。</p>
        <p>これに対して、<strong>嘘だけで畏怖が独立に作られず、嘘によって錯誤に陥り財物を出した</strong>場合（例：偽の警察手帳を見せて「証拠品として預かる」と言って高級品を取る）は、畏怖はそもそも介在せず、錯誤による交付＝詐欺。</p>
        <p>本問は前者のパターン。畏怖が太い幹で、虚偽は畏怖を太らせる枝葉。<strong>幹の罪名（恐喝）で吸収される</strong>のが判例の整理。</p>
      </div>

      <div class="prof-heading"><span class="prof-num">4</span>あてはめ</div>
      <p>本問では、甲は「他人を恐喝するに際して」「脅迫文言の中に虚偽の部分があり」「それも同人に畏怖の念を生じさせる一材料となって」「その畏怖の結果として」財物を交付させたとあります。文言の<strong>「畏怖の結果として」</strong>が判例の判断基準を直撃する。</p>
      <p>判例（<a class="ref-case" id="ref-case-saiko-s24-2-8-002" href="#case-saiko-s24-2-8">最判昭24.2.8</a>）の立場では、財物交付の<span class="case-emphasis freq-high">究極的原因は畏怖</span>であり、虚偽は畏怖を強化する一材料に過ぎない。よって<a class="ref-stat" id="ref-law-249-002" href="#law-249">249条1項</a>恐喝罪のみが成立し、<a class="ref-stat" id="ref-law-246-004" href="#law-246">246条1項</a>詐欺罪は成立しない。これは結論<span class="case-emphasis freq-high">Ⅲ「詐欺罪は成立しない」</span>に該当する。</p>

      <div class="warning">
        <p>「脅迫の中に嘘があるなら、嘘の部分は詐欺＋脅迫の部分は恐喝＝両方成立」と考えてはいけません。判例は<strong>究極的原因論</strong>で処理する。虚偽が独立した欺罔として機能していなければ詐欺罪は成立しない。<span class="exam-mark freq-mid">「畏怖の一材料」</span>という文言が判例キーワード。</p>
      </div>

      <div class="cross-link">
        <p><strong>因果関係論との接続</strong>：詐欺罪が成立するためには「欺罔→錯誤→処分→財物移転」の<span class="exam-mark freq-mid">独立した因果連鎖</span>が必要。本問のように欺罔が畏怖に吸収される場合、独立した因果連鎖を観念できないので詐欺罪は成立しない。<strong>因果関係の独立性</strong>を罪数論に応用した処理。</p>
      </div>
    </div>

    <div class="choice-points">
      <ol>
        <li>脅迫文言中の虚偽が<strong>畏怖を強化する一材料</strong>に過ぎず、究極的原因が畏怖であれば恐喝罪のみ成立。</li>
        <li><a class="ref-case" href="#case-saiko-s24-2-8">最判昭24.2.8</a>：「<strong>畏怖の結果として相手方が財物を交付するに至つた場合は詐欺罪ではなく恐喝罪となる</strong>」。</li>
        <li>記述イは<strong>結論Ⅲ「詐欺罪は成立しない」</strong>に該当（→ 「詐欺罪と恐喝罪の双方が成立し得る」とする結論Ⅱは誤り）。</li>
      </ol>
    </div>
    <div class="back-to-top"><a href="#top">↑ ページ先頭へ</a></div>
  </section>
  ...
  <section class="choice-section odd" id="choice-3">
    <nav class="sec-nav"><a href="#choice-2">←記述イ</a><a href="#choice-4">記述エ→</a></nav>

    <div class="choice-header-block">
      <div class="choice-big-badge">ウ</div>
      <span class="verdict verdict-incorrect">→ 結論Ⅲ 詐欺罪は成立しない</span>
      <div class="choice-summary">集金員が正規の手続で集金する行為は購読者に対する欺罔・損害を生じないため詐欺罪は成立せず、その後の費消が業務上横領罪となる</div>
    </div>

    <div class="sub-card original">
      <span class="label">記述原文</span>
      <p>新聞販売店から集金業務を委託されている集金員が、集金した購読料を同店に持ち帰らずに自己の用途に費消するつもりであるのに、これを秘して、正規の手続や方式に従って購読者から購読料を集金し、自己の遊興費に費消した。</p>
    </div>

    <div class="sub-card explanation">
      <h4>📖 解説原文</h4>
      <p><a class="ref-case" id="ref-case-tokyo-s28-6-12-001" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a>は、無尽契約の募集および掛金の集金に従事している者が、自己の用途に消費するつもりで、会社に入金する意思のないことを秘して無尽掛金を受領した事案で、「<span class="exam-mark freq-high">被告人が右集金行為後に右金員を擅に自己の用途に費消或はその目的の為に着服したときは業務上横領罪が成立する……は格別、集金行為が詐欺罪にあたるものということはできない</span>」としている。理由として、「正当権限を有する被告人に無尽掛金として交付した……支払行為は即時且当然に右会社に対して有効な掛金の支払となるものであつて、被告人に右集金の際受領金の使途について不法の意図があつたとしても、<span class="exam-mark freq-high">右は単に動機の不法に過ぎないもので右集金行為を違法ならしめるものではない</span>」ということを挙げている。したがって、ウの記述では<span class="case-emphasis freq-high">詐欺罪は成立しない</span>（結論Ⅲ）。</p>
    </div>
    ...
    <div class="sub-card basis-link">
      ...
      <div class="back-link-row">
        <a class="back-link" href="#law-246">→ 246条1項（詐欺）</a>
        <a class="back-link" href="#law-253">→ 253条（業務上横領）</a>
        <a class="back-link" href="#case-tokyo-s28-6-12">→ 東京高判昭28.6.12</a>
      </div>
      <p style="font-size:.92em; margin-top:6px;">「動機の不法」と「行為の違法性」を区別する判例理論。集金行為は適法、その後の費消が横領。</p>
    </div>
    ...
    <div class="sub-card professor">
      ...
      <div class="prof-heading"><span class="prof-num">1</span>ポイント</div>
      <p>要するに、<strong>適法な集金権限者が「あとで横領する気でいる」ことを秘して集金した場合、購読者に対する詐欺罪が成立するのか</strong>、を聞いています。詐欺罪の<span class="case-emphasis freq-high">「欺罔行為」</span>と<span class="case-emphasis freq-high">「動機の不法」</span>の関係。</p>

      <div class="prof-heading"><span class="prof-num">2</span>考え方の道筋</div>
      <p>まず<a class="ref-stat" id="ref-law-246-005" href="#law-246">246条1項</a>詐欺罪の構成要件を確認します。①<span class="exam-mark freq-mid">欺罔行為</span>→②錯誤→③処分行為→④財物の移転、の<strong>4 段階の因果連鎖</strong>が必要です。本問で問題となるのは<strong>①欺罔行為があるか</strong>──集金員は購読者に対して何を「欺いた」のか。</p>
      <p>本問の集金員は<span class="case-emphasis freq-high">正規の集金権限を有し、正規の手続・方式で集金</span>している。購読者が支払う購読料は、即時かつ当然に新聞販売店に対する有効な弁済となる。<strong>購読者が交付した時点で、購読者の債務は完全に消滅し、財産上の損害も発生していない</strong>。</p>
      <p>集金員の「あとで横領するつもりだ」という内心は、購読者にとって支払の動機・判断に関係のない事項。判例は、これを<span class="ron-mark freq-high">「単なる動機の不法に過ぎず、集金行為を違法ならしめるものではない」</span>とする。よって購読者に対する欺罔行為は成立せず、詐欺罪は不成立。</p>
      <p>もっとも、集金後に集金員が金員を自己の用途に費消した時点で、<strong>業務上自己の占有する他人の物（新聞販売店の所有金）を横領</strong>したものとして、<a class="ref-stat" id="ref-law-253-001" href="#law-253">253条</a>業務上横領罪が成立する。</p>

      <div class="key-phrase-box">
        集金権限ある者の<span class="kp-strong">正規の集金行為は適法</span>──購読者に欺罔・錯誤・損害なし。<br>
        その後の費消が<span class="kp-strong">業務上横領罪</span>を構成。<span class="kp-strong">「動機の不法」は行為の違法性を生まない</span>。
      </div>

      <div class="prof-heading"><span class="prof-num">3</span>イメージで掴む</div>
      <div class="prof-analogy">
        <span class="scene-title">場面：銀行窓口係の心の中</span>
        <p>銀行の窓口係が、預金者から「定期預金として預けたい」と100万円を受け取る。窓口係は規定通り入金処理を行い、預金者には正規の預金通帳記帳を渡す。<strong>預金者の手続は完璧に完了し、預金債権が銀行に対して有効に成立する</strong>。</p>
        <p>このとき窓口係が<strong>心の中で「あとで金庫から抜き取って自分のものにしよう」と企んでいた</strong>──しかし、預金者は何も騙されていない。手続も金額も預金口座も、すべて正規。預金者が後で銀行に行けば、100万円分の預金が確実に存在する。</p>
        <p>窓口係の悪意は、<strong>銀行に対する横領を準備する内心</strong>ではあっても、<strong>預金者に対する欺罔ではない</strong>。預金者には欺罔も錯誤も損害もない。後で窓口係が金庫から抜き取った時点で、業務上横領罪が完成する。</p>
        <p>本問の集金員も同じ。<strong>購読者から見れば一円の損もなく、契約上の支払いを完了している</strong>。集金員の心の中の悪意は、新聞販売店との関係で問題になるだけで、購読者との関係では「欺罔」を構成しない。</p>
      </div>

      <div class="prof-heading"><span class="prof-num">4</span>あてはめ</div>
      <p>本問では、集金員は「集金業務を委託されている」集金員であり、正規の権限を有しています。集金は「正規の手続や方式に従って」行われています。購読者は購読料を支払うことで購読料債務を完全に履行しており、<strong>購読者に欺罔・錯誤・財産的損害はない</strong>。</p>
      <p>集金員が「自己の用途に費消するつもり」であった内心は、判例（<a class="ref-case" id="ref-case-tokyo-s28-6-12-002" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a>）の言葉で言えば<span class="case-emphasis freq-high">「単に動機の不法に過ぎない」</span>。集金行為を違法ならしめるものではないので、購読者に対する<a class="ref-stat" id="ref-law-246-006" href="#law-246">246条1項</a>詐欺罪は成立しない。</p>
      <p>その後、集金した金員を「自己の遊興費に費消」した時点で、業務上自己の占有する他人（新聞販売店）の物を横領したものとして<a class="ref-stat" id="ref-law-253-002" href="#law-253">253条</a>業務上横領罪が成立する。これは結論<span class="case-emphasis freq-high">Ⅲ「詐欺罪は成立しない」</span>に該当する。</p>

      <div class="warning">
        <p>「集金員は『あとで横領するつもりだ』ということを秘して集金した＝『不法の意図を秘した』＝欺罔行為がある」と単純化してはいけません。判例は<strong>不法の意図そのものは欺罔行為を構成しない</strong>とする。<span class="case-emphasis freq-mid">購読者の意思決定にとって関係のない内心の不法</span>は、欺罔の対象とならない。</p>
      </div>

      <div class="cross-link">
        <p><strong>横領罪と詐欺罪の体系（刑法各論）</strong>：横領罪は<span class="exam-mark freq-mid">自己の占有する他人の物を領得</span>する罪（占有移転なし）。詐欺罪は<span class="exam-mark freq-mid">欺罔により他人の財物の交付を受ける</span>罪（占有移転あり）。本問は集金時点で占有が適法に移転しているので、後の費消は横領（占有自体は適法）。占有移転の適法性が<strong>横領と詐欺の分水嶺</strong>。</p>
      </div>
    </div>

    <div class="choice-points">
      <ol>
        <li>正規の集金権限者が<strong>正規の手続・方式で集金</strong>する行為は、購読者に対する欺罔行為とならず詐欺罪は成立しない。</li>
        <li><a class="ref-case" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a>：「<strong>動機の不法は集金行為を違法ならしめるものではない</strong>」。費消行為が<a class="ref-stat" href="#law-253">業務上横領罪（253条）</a>を構成。</li>
        <li>記述ウは<strong>結論Ⅲ「詐欺罪は成立しない」</strong>に該当（→ 「詐欺罪と業務上横領罪の双方が成立し得る」とする結論Ⅱは誤り）。</li>
      </ol>
    </div>
    <div class="back-to-top"><a href="#top">↑ ページ先頭へ</a></div>
  </section>

  <!-- =============== 肢4（記述エ：放火→詐欺の実行着手にあらず・結論Ⅲ） =============== -->
  <section class="choice-section even" id="choice-4">
    <nav class="sec-nav"><a href="#choice-3">←記述ウ</a><a href="#choice-5">記述オ→</a></nav>

    <div class="choice-header-block">
      <div class="choice-big-badge">エ</div>
      <span class="verdict verdict-correct">✓ 結論Ⅲ</span>
      <div class="choice-summary">保険金詐取目的で家屋に放火しただけでは詐欺罪の実行着手とはいえず、放火罪のみが成立する</div>
    </div>

    <div class="sub-card original">
      <span class="label">選択肢原文</span>
      <p>保険金を詐取する目的で、火災保険の付された自己所有の家屋に放火した。</p>
    </div>

    <div class="sub-card explanation">
      <h4>📖 解説原文</h4>
      <p><a class="ref-case" id="ref-case-daihan-m5-12-12-001" href="#case-daihan-m5-12-12">大判明5.12.12</a>は、保険金詐取の目的で家屋に放火し、放火の事実を秘して原因不明の出火により家屋が焼失したごとく装って、保険会社に保険金の支払いを請求し保険金の交付を受けた事案において、<span class="exam-mark freq-high">詐欺罪が成立する</span>としている。判例に賛成する学説は、理由として、<span class="ron-mark freq-high">詐欺罪の実行の着手時期は、行為者が詐欺の意思で人に対し欺罔行為を開始したとき</span>であり、保険金を詐取する目的で保険の目的物である家屋に放火しただけでは、人に対して欺罔行為を行っていないから実行の着手とはいえず、<span class="exam-mark freq-high">失火を装って保険会社に保険金の支払いを請求して初めて実行の着手となる</span>ということを挙げている。したがって、エの記述（放火しただけの段階）では<span class="case-emphasis freq-high">詐欺罪は成立しない</span>。</p>
    </div>

    <div class="sub-card basis-link">
      <h4>📚 根拠条文・判例</h4>
      <div class="back-link-row">
        <a class="back-link" href="#law-246">→ 246条1項（詐欺罪）</a>
        <a class="back-link" href="#law-109">→ 109条2項（自己所有非現住建造物等放火罪）</a>
        <a class="back-link" href="#case-daihan-m5-12-12">→ 大判明5.12.12</a>
      </div>
      <p style="font-size:.92em; margin-top:6px;">「実行の着手時期＝欺罔行為の開始時」という詐欺罪論点の<strong>古典的リーディングケース</strong>。</p>
    </div>
    ...
    <div class="sub-card professor">
      ...
      <div class="prof-heading"><span class="prof-num">1</span>ポイント</div>
      <p>要するに、<strong>保険金詐取目的で放火した段階で、詐欺罪の実行に着手したといえるか</strong>、を聞いています。<span class="case-emphasis freq-high">詐欺罪の実行着手時期</span>と、<span class="case-emphasis freq-high">放火罪との罪数関係</span>を二段で問う問題。</p>

      <div class="prof-heading"><span class="prof-num">2</span>考え方の道筋</div>
      <p>まず、<a class="ref-stat" id="ref-law-246-007" href="#law-246">246条1項</a>詐欺罪の構成要件を確認します。①<span class="exam-mark freq-mid">欺罔行為</span>→②錯誤→③処分行為→④財物の移転、の<strong>4 段階の因果連鎖</strong>が必要です。実行の着手は、<span class="ron-mark freq-high">①の欺罔行為を開始した時点</span>です。</p>
      <p>本問の犯人は、保険金詐取という<strong>最終目的</strong>を持って放火しています。しかし、<strong>放火の段階では「人を欺く行為」がまだ存在しない</strong>──火を放った相手は「家屋」であり、保険会社の担当者ではない。保険会社に対して何かを偽った瞬間（保険金請求書を提出するとか、失火と偽って通報するとか）が初めて<span class="case-emphasis freq-high">欺罔行為の開始＝実行の着手</span>となります。</p>
      <p>判例（<a class="ref-case" id="ref-case-daihan-m5-12-12-002" href="#case-daihan-m5-12-12">大判明5.12.12</a>）は、保険会社への保険金請求の段階で初めて詐欺罪の実行着手があり、詐欺罪が成立するとしました。逆に言えば、<strong>放火しただけで保険金請求に至っていない本問の段階では、詐欺罪も詐欺未遂罪も成立しない</strong>。</p>
      <p>放火行為については、火災保険の付された<strong>自己所有の家屋</strong>に対する放火なので、<a class="ref-stat" id="ref-law-109-001" href="#law-109">109条2項</a>（自己所有非現住建造物等放火罪）が成立し得ます（非現住・自己所有なので燃焼によって公共の危険を生じた場合に限る）。</p>

      <div class="key-phrase-box">
        詐欺罪の実行の着手＝<span class="kp-strong">「人に対する欺罔行為の開始」</span>。<br>
        保険金詐取目的の放火は<span class="kp-strong">予備段階</span>に過ぎず、<span class="kp-strong">保険会社への請求時点で初めて着手</span>。
      </div>

      <div class="prof-heading"><span class="prof-num">3</span>イメージで掴む</div>
      <div class="prof-analogy">
        <span class="scene-title">場面：ジョーカーを仕込むイカサマ師、まだ配ってはいない</span>
        <p>ポーカー師が客から大金を巻き上げる目的で、自宅で<strong>カードにジョーカーを仕込んでいる</strong>──下準備中。この段階で警察に踏み込まれても、<strong>「詐欺の実行に着手した」とは言えない</strong>。なぜなら、まだ客と向き合ってカードを配っていない、嘘も言っていない、誰も騙していない。</p>
        <p>仕込みが完成して、客の前に座り、<strong>「今日はみんな運がいいですよ」と笑顔で配り始めた瞬間</strong>──ここで初めて、客を騙す行為がスタートする。これが詐欺罪の<strong>実行の着手</strong>。</p>
        <p>本問の放火も全く同じ。家屋に火を放った段階は「仕込み」──火災という<strong>偽装の道具</strong>を作っているだけで、<strong>保険会社という被害者の前に出て嘘をつくのは、その後の保険金請求の場面</strong>。だから放火の段階では詐欺罪の実行の着手はなく、放火罪のみが成立する。詐欺罪は、保険会社への請求書を出した瞬間にようやく動き出す。</p>
      </div>

      <div class="prof-heading"><span class="prof-num">4</span>あてはめ</div>
      <p>本問では、犯人は保険金詐取の目的で自己所有の家屋に放火しただけで止まっています。<strong>保険会社に対する保険金請求や失火を装う通報は、まだ行っていない</strong>。よって、人を欺く行為＝欺罔行為がいまだ開始されていないため、<a class="ref-stat" id="ref-law-246-008" href="#law-246">246条1項</a>詐欺罪の実行の着手がない。詐欺罪・詐欺未遂罪ともに不成立。</p>
      <p>これは結論<span class="case-emphasis freq-high">Ⅲ「詐欺罪は成立しない」</span>に該当する。なお、放火行為自体は、自己所有の非現住建造物に対する放火として<a class="ref-stat" id="ref-law-109-003" href="#law-109">109条2項</a>放火罪が成立する余地があるが、本問は「詐欺罪と他罪の成否」を問うているため、放火罪の成否は結論Ⅲと両立する。</p>

      <div class="warning">
        <p>「保険金詐取の<strong>目的</strong>で放火＝詐欺の着手」と短絡してはいけません。判例は<strong>主観面（詐欺の目的）と客観面（欺罔行為の開始）を厳格に区別</strong>します。主観に欺罔の意思があっても、客観的に「人に対する欺罔行為」がなければ実行の着手は認められない。<span class="exam-mark freq-mid">客観的構成要件該当性</span>が必須。</p>
      </div>

      <div class="cross-link">
        <p><strong>実行の着手論（刑法総論）との接続</strong>：判例の実行着手時期論は<span class="exam-mark freq-mid">「形式的客観説」と「実質的客観説」</span>の対立を内包する。判例は基本的に<span class="case-emphasis freq-mid">構成要件該当行為の開始時</span>を着手とするが、詐欺罪では「人に対する欺罔行為の開始」が明確に着手時点とされる。総論の着手論と各論の各罪解釈が結びつく場面。</p>
      </div>
    </div>

    <div class="choice-points">
      <ol>
        <li><a class="ref-stat" href="#law-246">246条1項</a>詐欺罪の実行の着手は<strong>「人に対する欺罔行為の開始」</strong>。主観に詐欺目的があっても客観的欺罔がなければ着手なし。</li>
        <li><a class="ref-case" href="#case-daihan-m5-12-12">大判明5.12.12</a>：保険金詐取目的の放火は予備段階。<strong>保険会社への保険金請求時に初めて着手</strong>。</li>
        <li>記述エは放火段階で止まっているため<strong>結論Ⅲ「詐欺罪は成立しない」</strong>に該当（放火罪<a class="ref-stat" href="#law-109">109条2項</a>の成否は別問題）。</li>
      </ol>
    </div>
    <div class="back-to-top"><a href="#top">↑ ページ先頭へ</a></div>
  </section>

  <!-- =============== 肢5（記述オ：偽造通貨行使に詐欺包含・結論Ⅲ） =============== -->
  <section class="choice-section odd" id="choice-5">
    <nav class="sec-nav"><a href="#choice-4">←記述エ</a><a href="#basis">↓共通根拠</a></nav>

    <div class="choice-header-block">
      <div class="choice-big-badge">オ</div>
      <span class="verdict verdict-correct">✓ 結論Ⅲ</span>
      <div class="choice-summary">偽造通貨行使による財物領得は、偽造通貨行使罪に包含され、別個に詐欺罪は成立しない</div>
    </div>

    <div class="sub-card original">
      <span class="label">選択肢原文</span>
      <p>他人に売買代金として偽造通貨を行使し、同人を錯誤に陥らせて財物を交付させた。</p>
    </div>

    <div class="sub-card explanation">
      <h4>📖 解説原文</h4>
      <p><a class="ref-case" id="ref-case-daihan-m43-6-30-001" href="#case-daihan-m43-6-30">大判明43.6.30</a>は、偽造通貨を行使して財物を不正領得した事案で、<span class="ron-mark freq-high">財物領得行為は、偽造通貨行使に包含され、別に犯罪を構成しない</span>とする。判例に賛成する学説は、理由として、<span class="exam-mark freq-high">通貨は本来的支払手段である</span>から、<a class="ref-stat" id="ref-law-148-001" href="#law-148">偽造通貨行使罪（148条2項）</a>の刑は重く、この場合に詐欺罪の成立を認めると<span class="exam-mark freq-high">収得後知情行使罪（152条）についても詐欺罪が成立することになり、収得後知情行使罪を特に軽く処罰する趣旨が没却される</span>ということを挙げている。よって、オの記述では<span class="case-emphasis freq-high">詐欺罪は成立しない</span>（偽造通貨行使罪のみ成立）。</p>
    </div>
    ...
    <div class="sub-card basis-link">
      ...
      <div class="back-link-row">
        <a class="back-link" href="#law-246">→ 246条1項（詐欺罪）</a>
        <a class="back-link" href="#law-148">→ 148条2項（偽造通貨行使罪）</a>
        <a class="back-link" href="#case-daihan-m43-6-30">→ 大判明43.6.30</a>
      </div>
      <p style="font-size:.92em; margin-top:6px;">「<strong>法条競合（吸収関係）</strong>」の古典的事例。詐欺罪が偽造通貨行使罪に吸収される。</p>
    </div>
    ...
    <div class="sub-card professor">
      ...
      <div class="prof-heading"><span class="prof-num">1</span>ポイント</div>
      <p>要するに、<strong>偽造通貨を使って買物をして商品を騙し取った場合、偽造通貨行使罪と詐欺罪の両方が成立するのか、それとも偽造通貨行使罪のみか</strong>、を聞いています。<span class="case-emphasis freq-high">罪数論（法条競合・吸収関係）</span>と<span class="case-emphasis freq-mid">152条均衡論</span>を組み合わせた判例の論理を理解する問題。</p>

      <div class="prof-heading"><span class="prof-num">2</span>考え方の道筋</div>
      <p>偽造通貨を売買代金として渡し、相手を錯誤に陥らせて財物を交付させた行為は、形式的には<strong>2 つの構成要件</strong>に該当します。①<a class="ref-stat" id="ref-law-148-003" href="#law-148">148条2項</a>偽造通貨行使罪（行使）、②<a class="ref-stat" id="ref-law-246-009" href="#law-246">246条1項</a>詐欺罪（欺罔→錯誤→処分→交付）。</p>
      <p>判例は<strong>偽造通貨行使罪のみが成立し、詐欺罪は別個に成立しない</strong>とします。これは罪数論上の<span class="case-emphasis freq-high">法条競合（吸収関係）</span>──詐欺罪が偽造通貨行使罪に吸収される、と捉える立場です。</p>
      <p>判例の論拠は2つ。<strong>第一に、通貨は「本来的支払手段」</strong>であり、偽造通貨を支払手段として使用する行為自体に、相手方を欺いて財物を取得する詐欺的要素が<strong>類型的・必然的に内包</strong>されている。立法者はこの点を考慮して偽造通貨行使罪を詐欺罪（10年以下）よりはるかに重く（無期又は3年以上の懲役）設定した。</p>
      <p><strong>第二（より決定的）に、152条均衡論</strong>──<a class="ref-stat" id="ref-law-148-004" href="#law-148">152条</a>収得後知情行使罪（偽造通貨と知らずに受け取った後にそれを行使する罪。法定刑は通貨額面の3倍以下の罰金・科料と<strong>極めて軽い</strong>）にも詐欺罪が併存するとなると、152条を軽く処罰した立法趣旨が没却される。152条との横並びを考えれば、<span class="exam-mark freq-high">偽造通貨行使に詐欺罪を併存させてはならない</span>。</p>

      <div class="key-phrase-box">
        偽造通貨行使と詐欺は<span class="kp-strong">法条競合（吸収）</span>──偽造通貨行使罪のみ成立。<br>
        <span class="kp-strong">152条（収得後知情行使罪）との均衡</span>から、詐欺罪併存を否定するのが判例。
      </div>

      <div class="prof-heading"><span class="prof-num">3</span>イメージで掴む</div>
      <div class="prof-analogy">
        <span class="scene-title">場面：偽札と一緒に届けられる商品──「お代はこちらに」</span>
        <p>八百屋で偽造一万円札を出して野菜を買って帰る客の姿は、「<strong>偽札を使った</strong>」場面と「<strong>野菜を騙し取った</strong>」場面が同時に起きている。<strong>偽札を出す＝相手を騙して財物を取る</strong>という構造は、もう偽造通貨行使罪の中に最初から組み込まれている。立法者は「偽造通貨を行使する」という一つの行為に、<strong>「相手の財物を取る」という典型的結果まで含めて</strong>重い刑（無期又は3年以上）を用意した。</p>
        <p>ここで詐欺罪（10年以下）を別に立てるのは、<strong>すでに大きな袋の中に入っているものを、もう一度小さな袋に詰め直して別個に運ぼうとする</strong>ようなもの──二重評価の冗長性が出てしまう。</p>
        <p>さらに決定打が<strong>152条との並び</strong>。後で偽札と気付いた人がそれを使う場合（収得後知情行使罪）の法定刑は<strong>通貨額面の3倍以下の罰金</strong>──ものすごく軽い。立法者は「うっかり受け取った後の行使は軽く扱おう」と意図した。ところが152条にも詐欺罪が併設されるとなると、結局10年以下の懲役で処罰されることになり、<strong>152条を軽く設定した立法者の意図が完全に台無し</strong>になる。だから152条にも詐欺罪は付かない──そして148条2項にも詐欺罪は付かない、という整合性を判例は確保している。</p>
      </div>

      <div class="prof-heading"><span class="prof-num">4</span>あてはめ</div>
      <p>本問では、犯人は他人に売買代金として偽造通貨を行使し、相手を錯誤に陥らせて財物を交付させています。形式的には偽造通貨行使罪と詐欺罪の両方の構成要件に該当しますが、判例（<a class="ref-case" id="ref-case-daihan-m43-6-30-002" href="#case-daihan-m43-6-30">大判明43.6.30</a>）によれば、<strong>財物領得行為は偽造通貨行使罪に包含され、別個に詐欺罪は成立しない</strong>。</p>
      <p>よって、本問は<a class="ref-stat" id="ref-law-148-005" href="#law-148">148条2項</a>偽造通貨行使罪のみが成立し、詐欺罪は成立しない。これは結論<span class="case-emphasis freq-high">Ⅲ「詐欺罪は成立しない」</span>に該当する。</p>

      <div class="warning">
        <p>「形式的に2 つの構成要件に該当するから両罪成立」と単純に判断してはいけません。罪数論上の<strong>法条競合・吸収関係</strong>の検討が必要。特に、立法者が<span class="case-emphasis freq-mid">特別法的・包括的</span>な構成要件を設けている場合、より一般的な構成要件（本問では詐欺罪）は吸収される。</p>
      </div>

      <div class="cross-link">
        <p><strong>罪数論との接続（刑法総論）</strong>：本問は<span class="case-emphasis freq-high">法条競合（特別関係・吸収関係）</span>の典型例。観念的競合（54条1項前段）や牽連犯（同後段）と区別する。法条競合は<strong>1 個の罪のみ成立</strong>（成立段階の問題）、観念的競合は<strong>複数の罪が成立しつつ刑だけ重い方</strong>（科刑段階の問題）。152条均衡論は立法者意思を考慮した解釈論として注目に値する。</p>
      </div>
    </div>

    <div class="choice-points">
      <ol>
        <li>偽造通貨を売買代金として行使し財物交付させる行為は、形式的には<strong>偽造通貨行使罪（<a class="ref-stat" href="#law-148">148条2項</a>）と詐欺罪（<a class="ref-stat" href="#law-246">246条1項</a>）の両構成要件に該当</strong>。</li>
        <li><a class="ref-case" href="#case-daihan-m43-6-30">大判明43.6.30</a>：両者は法条競合（吸収関係）。<strong>通貨の本来的支払手段性</strong>＋<strong>152条（収得後知情行使罪）との均衡</strong>が論拠。</li>
        <li>記述オは偽造通貨行使罪のみ成立で<strong>結論Ⅲ「詐欺罪は成立しない」</strong>に該当。</li>
      </ol>
    </div>
    <div class="back-to-top"><a href="#top">↑ ページ先頭へ</a></div>
  </section>
  ...
  <section class="section" id="basis">
    ...
    <!-- 条文246条 詐欺罪 -->
    <div class="basis-card statute-card" id="law-246">
      <div class="basis-card-header">📜 <span class="statute-emphasis freq-high">刑法第246条</span>（詐欺）<span class="freq-badge freq-high">★★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><span class="para-num">第1項</span><span class="hang-body"><span class="ron-mark freq-high">人を欺いて財物を交付させた者</span>は、十年以下の懲役に処する。</span></p>
        <p class="hanging"><span class="para-num">第2項</span><span class="hang-body">前項の方法により、<span class="ron-mark freq-high">財産上不法の利益を得、又は他人にこれを得させた者</span>も、同項と同様とする。</span></p>
        <div class="note">
          <strong>詐欺罪の構造</strong>：①<span class="case-emphasis freq-high">欺罔行為</span>→②<span class="case-emphasis freq-high">錯誤</span>→③<span class="case-emphasis freq-high">処分行為</span>→④<span class="case-emphasis freq-high">財物・利益の移転</span>の<span class="exam-mark freq-high">4 段階の因果連鎖</span>を必要とする。実行の着手は<span class="exam-mark freq-mid">欺罔行為の開始時点</span>。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-law-246-001">記述ア</a><a class="rb-chip" href="#ref-law-246-002">記述イ</a><a class="rb-chip" href="#ref-law-246-003">記述ウ</a><a class="rb-chip" href="#ref-law-246-004">記述エ</a><a class="rb-chip" href="#ref-law-246-005">記述オ</a><a class="rb-chip" href="#ref-law-246-006">C-1</a><a class="rb-chip" href="#ref-law-246-007">C-4</a><a class="rb-chip" href="#ref-law-246-008">C-7</a></div>
      </div>
    </div>

    <!-- 条文247条 背任罪 -->
    <div class="basis-card statute-card" id="law-247">
      <div class="basis-card-header">📜 <span class="statute-emphasis freq-mid">刑法第247条</span>（背任）<span class="freq-badge freq-mid">★★</span></div>
      <div class="basis-card-body">
        <p><span class="ron-mark freq-mid">他人のためにその事務を処理する者が、自己若しくは第三者の利益を図り又は本人に損害を加える目的で、その任務に背く行為をし、本人に財産上の損害を加えたとき</span>は、五年以下の懲役又は五十万円以下の罰金に処する。</p>
        <div class="note">
          <strong>詐欺罪との関係</strong>：背任行為が同時に欺罔行為としての性格を備える場合、判例は<span class="case-emphasis freq-mid">詐欺罪に当然包含</span>されるとして詐欺罪のみの成立を認める（法条競合・包括一罪の発想）。背任罪は別途構成しない。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-law-247-001">記述ア</a><a class="rb-chip" href="#ref-law-247-002">C-2</a><a class="rb-chip" href="#ref-law-247-003">C-4</a></div>
      </div>
    </div>

    <!-- 条文249条 恐喝罪 -->
    <div class="basis-card statute-card" id="law-249">
      <div class="basis-card-header">📜 <span class="statute-emphasis freq-mid">刑法第249条</span>（恐喝）<span class="freq-badge freq-mid">★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><span class="para-num">第1項</span><span class="hang-body"><span class="ron-mark freq-mid">人を恐喝して財物を交付させた者</span>は、十年以下の懲役に処する。</span></p>
        <p class="hanging"><span class="para-num">第2項</span><span class="hang-body">前項の方法により、財産上不法の利益を得、又は他人にこれを得させた者も、同項と同様とする。</span></p>
        <div class="note">
          <strong>詐欺罪との区別</strong>：恐喝＋欺罔が混在する場合、判例は<span class="exam-mark freq-mid">究極的に畏怖により処分行為が行われたか</span>で罪名を画する。虚偽部分が畏怖を生じさせる「一材料」に過ぎず、財物交付の根本原因が畏怖であれば、<span class="case-emphasis freq-mid">恐喝罪のみが成立</span>し詐欺罪は成立しない。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-law-249-001">記述イ</a><a class="rb-chip" href="#ref-law-249-002">C-2</a><a class="rb-chip" href="#ref-law-249-003">C-4</a></div>
      </div>
    </div>

    <!-- 条文253条 業務上横領罪 -->
    <div class="basis-card statute-card" id="law-253">
      <div class="basis-card-header">📜 <span class="statute-emphasis freq-mid">刑法第253条</span>（業務上横領）<span class="freq-badge freq-mid">★★</span></div>
      <div class="basis-card-body">
        <p><span class="ron-mark freq-mid">業務上自己の占有する他人の物を横領した者</span>は、十年以下の懲役に処する。</p>
        <div class="note">
          <strong>詐欺罪との関係</strong>：集金員等が委託に基づき正規の手続で集金した時点では、相手方に対する欺罔行為が観念されず<span class="case-emphasis freq-mid">詐欺罪は成立しない</span>。その後の費消行為が独立して業務上横領罪を構成する。判例は<span class="exam-mark freq-mid">「動機の不法は集金行為自体を違法ならしめない」</span>とする（東京高判昭28.6.12）。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-law-253-001">記述ウ</a><a class="rb-chip" href="#ref-law-253-002">C-2</a></div>
      </div>
    </div>

    <!-- 条文108-109条 放火罪 -->
    <div class="basis-card statute-card" id="law-109">
      <div class="basis-card-header">📜 <span class="statute-emphasis freq-mid">刑法第108条・第109条</span>（放火）<span class="freq-badge freq-mid">★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><span class="para-num">第108条</span><span class="hang-body">放火して、現に人が住居に使用し又は現に人がいる建造物……を焼損した者は、死刑又は無期若しくは五年以上の懲役に処する。</span></p>
        <p class="hanging"><span class="para-num">第109条1項</span><span class="hang-body">放火して、現に人が住居に使用せず、かつ、現に人がいない建造物……を焼損した者は、二年以上の有期懲役に処する。</span></p>
        <p class="hanging"><span class="para-num">第109条2項</span><span class="hang-body">前項の物が自己の所有に係るときは、六月以上七年以下の懲役に処する。</span></p>
        <div class="note">
          <strong>詐欺罪との関係</strong>：放火は<span class="case-emphasis freq-mid">詐欺罪の準備行為に過ぎず</span>、詐欺の実行の着手にはあたらない。判例（大判明5.12.12）は<span class="exam-mark freq-mid">保険会社への保険金請求行為（欺罔行為）の開始時点</span>で初めて詐欺罪の実行の着手を肯定する。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-law-109-001">記述エ</a><a class="rb-chip" href="#ref-law-109-020">C-2</a><a class="rb-chip" href="#ref-law-109-004">C-7</a></div>
      </div>
    </div>

    <!-- 条文148条2項 偽造通貨行使罪 -->
    <div class="basis-card statute-card" id="law-148">
      <div class="basis-card-header">📜 <span class="statute-emphasis freq-mid">刑法第148条2項</span>（偽造通貨行使）<span class="freq-badge freq-mid">★★</span></div>
      <div class="basis-card-body">
        <p>偽造又は変造の貨幣、紙幣又は銀行券を<span class="ron-mark freq-mid">行使し、又は行使の目的で人に交付し、若しくは輸入した者</span>も、前項と同様とする（無期又は三年以上の懲役）。</p>
        <p class="hanging"><span class="para-num">第152条</span><span class="hang-body">（収得後知情行使）貨幣、紙幣又は銀行券を収得した後に、それが偽造又は変造のものであることを知って、これを行使し、又は行使の目的で人に交付した者は、その額面価格の三倍以下の罰金又は科料に処する。但し、二千円以下にすることはできない。</span></p>
        <div class="note">
          <strong>詐欺罪との関係</strong>：判例（大判明43.6.30）は、<span class="case-emphasis freq-mid">財物領得行為は偽造通貨行使罪に包含され、別に詐欺罪を構成しない</span>とする。背景に①通貨は本来的支払手段で偽造通貨行使罪の刑が重い、②詐欺成立を認めると<span class="exam-mark freq-mid">152条（収得後知情行使罪・軽罪）の趣旨が没却</span>される、という政策的根拠がある。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-law-148-001">記述オ</a><a class="rb-chip" href="#ref-law-148-006">C-2</a><a class="rb-chip" href="#ref-law-148-007">C-4</a></div>
      </div>
    </div>

    <!-- 判例① 最判昭28.5.8（背任と詐欺） -->
    <div class="basis-card case-card" id="case-saiko-s28-5-8">
      <div class="basis-card-header">⚖ <span class="case-emphasis freq-high">最判昭和28年5月8日</span>──背任と詐欺の関係事件<span class="freq-badge freq-high">★★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><strong>【事案】</strong><span class="hang-body">他人の事務処理者が、その事務処理上任務に背いて本人に対し欺罔行為を行い、錯誤に陥らせて財物を交付させた事案。</span></p>
        <p class="judgment-text hanging"><strong>【判旨】</strong><span class="hang-body">「他人の委託によりその事務を処理する者が、その事務処理上任務に背き本人に対し欺罔行為を行い同人を錯誤に陥れ、よつて財物を交付せしめた場合には<span class="ron-mark freq-high">詐欺罪を構成し、たとい背任罪の成立要件を具備する場合でも別に背任罪を構成するものではない</span>」。</span></p>
        <div class="note">
          <strong>法条競合・包括一罪の発想</strong>：判例に賛成する学説は、<span class="case-emphasis freq-high">背任行為は詐欺罪の観念に当然に包含される</span>から別個に背任罪を構成しないとする。同一の財産的侵害行為について重い詐欺罪のみを成立させ、軽い背任罪は別途構成しない（吸収関係）。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-case-saiko-s28-5-8-001">記述ア</a><a class="rb-chip" href="#ref-case-saiko-s28-5-8-005">C-2</a><a class="rb-chip" href="#ref-case-saiko-s28-5-8-003">C-4</a><a class="rb-chip" href="#ref-case-saiko-s28-5-8-004">C-7</a></div>
      </div>
    </div>

    <!-- 判例② 最判昭24.2.8（恐喝と詐欺） -->
    <div class="basis-card case-card" id="case-saiko-s24-2-8">
      <div class="basis-card-header">⚖ <span class="case-emphasis freq-high">最判昭和24年2月8日</span>──恐喝と詐欺の関係事件<span class="freq-badge freq-high">★★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><strong>【事案】</strong><span class="hang-body">他人を恐喝するに際し、脅迫文言の中に虚偽の部分があり、その虚偽の部分も相手方に畏怖の念を生じさせる一材料となって、その畏怖の結果として相手方が財物を交付した事案。</span></p>
        <p class="judgment-text hanging"><strong>【判旨】</strong><span class="hang-body">「被告人の施用した手段の中に虚偽の部分……があつても、その部分も相手方に畏怖の念を生ぜしめる一材料となり、<span class="ron-mark freq-high">その畏怖の結果として相手方が財物を交付するに至つた場合は詐欺罪ではなく恐喝罪となる</span>」。</span></p>
        <div class="note">
          <strong>判断基準は「畏怖が究極的原因」かどうか</strong>：虚偽が単独で財物交付を惹起したのではなく、<span class="case-emphasis freq-high">畏怖を強化する一材料</span>に過ぎず、究極的には<span class="exam-mark freq-high">恐喝による畏怖の結果として財物が交付された</span>と評価される場合は、恐喝罪のみ成立する（詐欺罪は不成立）。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-case-saiko-s24-2-8-001">記述イ</a><a class="rb-chip" href="#ref-case-saiko-s24-2-8-005">C-2</a><a class="rb-chip" href="#ref-case-saiko-s24-2-8-003">C-4</a><a class="rb-chip" href="#ref-case-saiko-s24-2-8-004">C-7</a></div>
      </div>
    </div>

    <!-- 判例③ 東京高判昭28.6.12（集金員と詐欺） -->
    <div class="basis-card case-card" id="case-tokyo-s28-6-12">
      <div class="basis-card-header">⚖ <span class="case-emphasis freq-high">東京高判昭和28年6月12日</span>──集金員費消事件<span class="freq-badge freq-high">★★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><strong>【事案】</strong><span class="hang-body">無尽契約の募集および掛金の集金に従事している者が、自己の用途に消費するつもりで、会社に入金する意思のないことを秘して無尽掛金を受領した事案。</span></p>
        <p class="judgment-text hanging"><strong>【判旨】</strong><span class="hang-body">「<span class="ron-mark freq-high">被告人が右集金行為後に右金員を擅に自己の用途に費消或はその目的の為に着服したときは業務上横領罪が成立する</span>……は格別、集金行為が詐欺罪にあたるものということはできない」。理由として「正当権限を有する被告人に無尽掛金として交付した……支払行為は即時且当然に右会社に対して有効な掛金の支払となるものであつて、被告人に右集金の際受領金の使途について不法の意図があつたとしても、<span class="exam-mark freq-high">右は単に動機の不法に過ぎないもので右集金行為を違法ならしめるものではない</span>」とする。</span></p>
        <div class="note">
          <strong>「動機の不法は行為の違法性を生まない」</strong>：集金員は正当な集金権限を有し、購読者の支払は即時に新聞販売店に対して有効な弁済となる。<span class="case-emphasis freq-high">購読者は欺罔されていない・錯誤に陥っていない・損害を受けていない</span>──ゆえに購読者に対する詐欺罪は成立せず、その後の費消行為のみが業務上横領罪を構成する。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-case-tokyo-s28-6-12-001">記述ウ</a><a class="rb-chip" href="#ref-case-tokyo-s28-6-12-005">C-2</a><a class="rb-chip" href="#ref-case-tokyo-s28-6-12-007">C-3</a><a class="rb-chip" href="#ref-case-tokyo-s28-6-12-009">C-7</a></div>
      </div>
    </div>

    <!-- 判例④ 大判明5.12.12（放火と保険金詐欺・実行の着手） -->
    <div class="basis-card case-card" id="case-daihan-m5-12-12">
      <div class="basis-card-header">⚖ <span class="case-emphasis freq-high">大判明治5年12月12日</span>──保険金詐欺・実行の着手事件<span class="freq-badge freq-high">★★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><strong>【事案】</strong><span class="hang-body">保険金詐取の目的で家屋に放火し、放火の事実を秘して原因不明の出火により家屋が焼失したごとく装って、保険会社に保険金の支払を請求し保険金の交付を受けた事案。</span></p>
        <p class="judgment-text hanging"><strong>【判旨】</strong><span class="hang-body"><span class="ron-mark freq-high">放火行為の段階では詐欺罪の実行の着手にあたらず</span>、保険会社に対し失火を装って保険金請求を行った段階で初めて詐欺罪の実行の着手があるとした。</span></p>
        <div class="note">
          <strong>実行の着手は「欺罔行為の開始時点」</strong>：判例に賛成する学説は、<span class="case-emphasis freq-high">詐欺罪の実行の着手時期は、行為者が詐欺の意思で人に対し欺罔行為を開始したとき</span>とする。保険金を詐取する目的で保険の目的物である家屋に放火しただけでは<span class="exam-mark freq-high">人に対する欺罔行為を行っていない</span>から実行の着手とはいえず、<span class="case-emphasis freq-mid">失火を装って保険会社に保険金の支払いを請求して初めて実行の着手</span>となる。放火段階では詐欺罪は成立しない（放火罪は別途成立）。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-case-daihan-m5-12-12-001">記述エ</a><a class="rb-chip" href="#ref-case-daihan-m5-12-12-002">C-2</a><a class="rb-chip" href="#ref-case-daihan-m5-12-12-003">C-4</a><a class="rb-chip" href="#ref-case-daihan-m5-12-12-004">C-7</a></div>
      </div>
    </div>

    <!-- 判例⑤ 大判明43.6.30（偽造通貨行使と詐欺） -->
    <div class="basis-card case-card" id="case-daihan-m43-6-30">
      <div class="basis-card-header">⚖ <span class="case-emphasis freq-high">大判明治43年6月30日</span>──偽造通貨行使包含事件<span class="freq-badge freq-high">★★★</span></div>
      <div class="basis-card-body">
        <p class="hanging"><strong>【事案】</strong><span class="hang-body">偽造通貨を行使して財物を不正領得した事案。</span></p>
        <p class="judgment-text hanging"><strong>【判旨】</strong><span class="hang-body"><span class="ron-mark freq-high">財物領得行為は偽造通貨行使罪に包含され、別に犯罪を構成しない</span>とする。</span></p>
        <div class="note">
          <strong>政策的根拠：軽罪（152条）の趣旨保全</strong>：判例に賛成する学説は、①通貨は本来的な支払手段であり、偽造通貨行使罪（<a class="ref-stat" href="#law-148">148条2項</a>）の刑が重い、②この場合に詐欺罪成立を認めると、<span class="case-emphasis freq-high">収得後知情行使罪（152条）についても詐欺罪が成立することになり、収得後知情行使罪を特に軽く処罰する趣旨が没却される</span>──ということを挙げる。152条との均衡から、財物領得は偽造通貨行使罪に吸収される。
        </div>
        <div class="ref-backlinks"><a class="rb-chip" href="#ref-case-daihan-m43-6-30-001">記述オ</a><a class="rb-chip" href="#ref-case-daihan-m43-6-30-002">C-2</a><a class="rb-chip" href="#ref-case-daihan-m43-6-30-003">C-4</a><a class="rb-chip" href="#ref-case-daihan-m43-6-30-004">C-7</a></div>
      </div>
    </div>
  ...
  <section class="section" id="c-1">
    ...
    <h2 class="section-title"><span class="sec-icon">❀</span>C-1 体系的解説──詐欺罪と他罪の成否</h2>

    <h3>趣旨（Why）──詐欺罪体系における「他罪との関係」</h3>
    <div class="key-phrase-box">
      詐欺罪と他罪の関係を判断する基準は <span class="kp-strong">3つの軸</span>──<br>
      ①<span class="kp-strong">実行の着手時期</span>（記述エ：放火段階で着手なし）／<br>
      ②<span class="kp-strong">欺罔行為の対象・適法性</span>（記述ウ：正規集金は欺罔ならず／記述イ：恐喝の畏怖が究極原因）／<br>
      ③<span class="kp-strong">他罪との罪数関係（包含・吸収）</span>（記述ア：背任を包含／記述オ：偽造通貨行使に包含される）。
    </div>
    <p><a class="ref-stat" id="ref-law-246-010" href="#law-246">詐欺罪（246条）</a>は財産犯のうち、欺罔→錯誤→処分行為→財物・利益の移転、という<strong>4 段階の因果連鎖</strong>を要件とする犯罪類型です。他の財産犯（窃盗・恐喝・横領・背任）や財産犯ではない罪（放火・偽造通貨行使）と接する場面で、それぞれ独特の境界論が発生します。</p>
    <p>本問は、<span class="case-emphasis freq-high">古典的最高裁判例・大審院判例 5本</span>を素材として、詐欺罪と他罪の関係を網羅的に確認する基本問題。判例の論理を「<strong>着手時期</strong>」「<strong>欺罔の対象</strong>」「<strong>罪数関係</strong>」の3 軸で整理することで、本問が要求する判断を体系的に処理できます。</p>

    <h3>5 つの記述──結論一覧</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>記述</th><th>事案</th><th>結論</th><th>結びつく判例</th><th>判例の核心法理</th></tr>
        </thead>
        <tbody>
          <tr>
            <td>ア</td>
            <td>背任的欺罔行為で財物交付</td>
            <td><span class="case-emphasis freq-high">Ⅰ 詐欺罪のみ</span></td>
            <td><a class="ref-case" id="ref-case-saiko-s28-5-8-005" href="#case-saiko-s28-5-8">最判昭28.5.8</a></td>
            <td>背任は詐欺の観念に当然包含される</td>
          </tr>
          <tr class="row-key">
            <td><strong>イ</strong></td>
            <td>虚偽を含む脅迫で畏怖→交付</td>
            <td><span class="case-emphasis freq-high">Ⅲ 詐欺不成立</span></td>
            <td><a class="ref-case" id="ref-case-saiko-s24-2-8-005" href="#case-saiko-s24-2-8">最判昭24.2.8</a></td>
            <td>虚偽は畏怖の一材料に過ぎず、究極的には恐喝</td>
          </tr>
          <tr>
            <td>ウ</td>
            <td>集金員の不法意図秘匿集金</td>
            <td><span class="case-emphasis freq-high">Ⅲ 詐欺不成立</span></td>
            <td><a class="ref-case" id="ref-case-tokyo-s28-6-12-005" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a></td>
            <td>正規集金は適法、動機の不法に過ぎない</td>
          </tr>
          <tr class="row-key">
            <td><strong>エ</strong></td>
            <td>保険金詐取目的の放火</td>
            <td><span class="case-emphasis freq-high">Ⅲ 詐欺不成立</span></td>
            <td><a class="ref-case" id="ref-case-daihan-m5-12-12-003" href="#case-daihan-m5-12-12">大判明5.12.12</a></td>
            <td>放火は実行着手にあらず、請求時に着手</td>
          </tr>
          <tr>
            <td>オ</td>
            <td>偽造通貨行使で財物騙取</td>
            <td><span class="case-emphasis freq-high">Ⅲ 詐欺不成立</span></td>
            <td><a class="ref-case" id="ref-case-daihan-m43-6-30-020" href="#case-daihan-m43-6-30">大判明43.6.30</a></td>
            <td>偽造通貨行使に包含、152条均衡論</td>
          </tr>
        </tbody>
      </table>
    </div>
    <p style="font-size:.92em;">本問の正解は<strong>肢3（イⅢ─エⅢ）</strong>。「正しい組合せ」を問う形式で、5 記述中4 記述が結論Ⅲのため、<strong>イ・ウ・エ・オの中から2 つの組合せを選ぶ</strong>消去法的問題構造。</p>

    <h3>詐欺罪と他罪の関係──マインドマップ</h3>
    <div class="figure-wrap">
      <svg viewBox="0 0 760 540" xmlns="http://www.w3.org/2000/svg" font-family="'Shippori Mincho B1',serif">
        <!-- 中心 -->
        <ellipse cx="380" cy="270" rx="100" ry="50" fill="#8a1f3a" stroke="#dc4d71" stroke-width="2"/>
        <text x="380" y="265" text-anchor="middle" font-size="18" font-weight="700" fill="#fff">詐欺罪</text>
        <text x="380" y="285" text-anchor="middle" font-size="11" fill="#f1a3b6">246条1項・2項</text>

        <!-- 上：背任罪（包含・記述ア） -->
        <rect x="290" y="40" width="180" height="80" fill="#fff" stroke="#1b5e20" stroke-width="2" rx="8"/>
        <text x="380" y="64" text-anchor="middle" font-size="12" font-weight="700" fill="#1b5e20">背任罪（247条）</text>
        <text x="380" y="84" text-anchor="middle" font-size="10" fill="#231419">⇒ 詐欺に包含</text>
        <text x="380" y="100" text-anchor="middle" font-size="10" fill="#231419">記述ア・最判昭28.5.8</text>
        <text x="380" y="114" text-anchor="middle" font-size="10" fill="#1b5e20" font-weight="600">結論Ⅰ</text>
        <line x1="380" y1="120" x2="380" y2="220" stroke="#1b5e20" stroke-width="2"/>
        <text x="395" y="170" font-size="9" fill="#1b5e20">包含</text>

        <!-- 右上：恐喝罪（究極原因論・記述イ） -->
        <rect x="540" y="100" width="190" height="80" fill="#fff" stroke="#b00032" stroke-width="2" rx="8"/>
        <text x="635" y="124" text-anchor="middle" font-size="12" font-weight="700" fill="#b00032">恐喝罪（249条）</text>
        <text x="635" y="144" text-anchor="middle" font-size="10" fill="#231419">⇒ 究極原因が畏怖</text>
        <text x="635" y="160" text-anchor="middle" font-size="10" fill="#231419">記述イ・最判昭24.2.8</text>
        <text x="635" y="174" text-anchor="middle" font-size="10" fill="#b00032" font-weight="600">結論Ⅲ</text>
        <line x1="540" y1="170" x2="475" y2="245" stroke="#b00032" stroke-width="2"/>
        <text x="525" y="215" font-size="9" fill="#b00032">同居せず</text>

        <!-- 右下：業務上横領罪（記述ウ） -->
        <rect x="540" y="360" width="190" height="80" fill="#fff" stroke="#a07030" stroke-width="2" rx="8"/>
        <text x="635" y="384" text-anchor="middle" font-size="12" font-weight="700" fill="#7c5520">業務上横領（253条）</text>
        <text x="635" y="404" text-anchor="middle" font-size="10" fill="#231419">⇒ 動機の不法</text>
        <text x="635" y="420" text-anchor="middle" font-size="10" fill="#231419">記述ウ・東京高判昭28.6.12</text>
        <text x="635" y="434" text-anchor="middle" font-size="10" fill="#7c5520" font-weight="600">結論Ⅲ</text>
        <line x1="540" y1="380" x2="475" y2="300" stroke="#a07030" stroke-width="2"/>
        <text x="490" y="345" font-size="9" fill="#7c5520">事後横領のみ</text>

        <!-- 左下：放火罪（記述エ） -->
        <rect x="30" y="360" width="190" height="80" fill="#fff" stroke="#bf360c" stroke-width="2" rx="8"/>
        <text x="125" y="384" text-anchor="middle" font-size="12" font-weight="700" fill="#bf360c">放火罪（109条2項）</text>
        <text x="125" y="404" text-anchor="middle" font-size="10" fill="#231419">⇒ 実行着手未だなし</text>
        <text x="125" y="420" text-anchor="middle" font-size="10" fill="#231419">記述エ・大判明5.12.12</text>
        <text x="125" y="434" text-anchor="middle" font-size="10" fill="#bf360c" font-weight="600">結論Ⅲ</text>
        <line x1="220" y1="380" x2="285" y2="300" stroke="#bf360c" stroke-width="2"/>
        <text x="225" y="345" font-size="9" fill="#bf360c">予備段階</text>

        <!-- 左上：偽造通貨行使罪（記述オ） -->
        <rect x="30" y="100" width="190" height="80" fill="#fff" stroke="#1565c0" stroke-width="2" rx="8"/>
        <text x="125" y="124" text-anchor="middle" font-size="12" font-weight="700" fill="#1565c0">偽造通貨行使（148条2項）</text>
        <text x="125" y="144" text-anchor="middle" font-size="10" fill="#231419">⇒ 詐欺を包含</text>
        <text x="125" y="160" text-anchor="middle" font-size="10" fill="#231419">記述オ・大判明43.6.30</text>
        <text x="125" y="174" text-anchor="middle" font-size="10" fill="#1565c0" font-weight="600">結論Ⅲ</text>
        <line x1="220" y1="170" x2="285" y2="245" stroke="#1565c0" stroke-width="2"/>
        <text x="235" y="215" font-size="9" fill="#1565c0">吸収</text>

        <!-- 底部：3軸の凡例 -->
        <rect x="180" y="470" width="400" height="56" fill="#fdf0f3" stroke="#dc4d71" stroke-width="1.5" rx="6"/>
        <text x="380" y="490" text-anchor="middle" font-size="11" font-weight="700" fill="#8a1f3a">判断3軸</text>
        <text x="380" y="508" text-anchor="middle" font-size="10" fill="#231419">①実行の着手時期(エ)　②欺罔の対象・適法性(イ・ウ)　③罪数関係(ア・オ)</text>
      </svg>
      <p class="figure-caption">図1：詐欺罪と他罪の関係マインドマップ──5 記述・5 判例・3 判断軸の体系</p>
    </div>
  ...
  <section class="section" id="c-2">
    ...
    <h3>詐欺罪と隣接諸罪の比較</h3>
    <div class="key-phrase-box">
      区別の核：<span class="kp-strong">欺罔の対象</span>・<span class="kp-strong">行為の適法性</span>・<span class="kp-strong">着手時期</span>・<span class="kp-strong">罪数関係</span>の4 軸。
    </div>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>項目</th><th>詐欺罪<br>(246条)</th><th>背任罪<br>(247条)</th><th>恐喝罪<br>(249条)</th><th>業務上横領<br>(253条)</th><th>偽造通貨行使<br>(148条2項)</th><th>放火罪<br>(108-110条)</th></tr>
        </thead>
        <tbody>
          <tr><td>保護法益</td><td>個人財産</td><td>本人の財産</td><td>個人財産＋意思の自由</td><td>個人財産＋信頼</td><td>通貨に対する公共の信用</td><td>公共の安全</td></tr>
          <tr><td>主たる手段</td><td>欺罔</td><td>任務違背</td><td>暴行・脅迫(畏怖)</td><td>占有物の領得</td><td>偽造通貨の行使</td><td>放火</td></tr>
          <tr><td>処分行為</td><td>必要</td><td>不要</td><td>必要</td><td>不要(横領自体が処分)</td><td>不要(行使で完成)</td><td>不要</td></tr>
          <tr><td>本問該当肢</td><td>すべて(対象)</td><td>記述ア(包含)</td><td>記述イ(究極原因)</td><td>記述ウ(事後)</td><td>記述オ(包含する)</td><td>記述エ(予備)</td></tr>
          <tr><td>法定刑</td><td>10年以下懲役</td><td>5年以下懲役</td><td>10年以下懲役</td><td>10年以下懲役</td><td><strong>無期又は3年以上</strong></td><td>2年〜死刑(類型別)</td></tr>
        </tbody>
      </table>
    </div>

    <h3>結論Ⅰ・Ⅱ・Ⅲ の判別ルール</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>結論</th><th>内容</th><th>典型場面</th><th>本問該当</th></tr>
        </thead>
        <tbody>
          <tr class="row-key">
            <td><strong>Ⅰ</strong></td>
            <td>詐欺罪のみが成立し得る</td>
            <td>他罪の構成要件にも該当するが詐欺罪に「包含」され、他罪は別個に成立しない</td>
            <td>記述ア(背任を包含)</td>
          </tr>
          <tr>
            <td>Ⅱ</td>
            <td>詐欺罪と他の罪の双方が成立し得る</td>
            <td>観念的競合・併合罪等で両罪併存</td>
            <td><span class="ng-cell">なし（5記述中Ⅱは0）</span></td>
          </tr>
          <tr class="row-key">
            <td><strong>Ⅲ</strong></td>
            <td>詐欺罪は成立しない</td>
            <td>欺罔行為がない／実行着手なし／他罪に吸収される／違法性なし／究極原因が別罪</td>
            <td>記述イ・ウ・エ・オ(4記述)</td>
          </tr>
        </tbody>
      </table>
    ...
    <h3>記述Ⅲ（詐欺不成立）の <strong>4 つの不成立メカニズム</strong></h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>記述</th><th>不成立メカニズム</th><th>判例の論理構造</th><th>結論として成立する罪</th></tr>
        </thead>
        <tbody>
          <tr>
            <td>イ</td>
            <td><strong>究極原因が別罪</strong></td>
            <td>虚偽は畏怖の一材料に過ぎず、財物交付の究極的原因は畏怖→恐喝罪</td>
            <td>恐喝罪(249条)</td>
          </tr>
          <tr>
            <td>ウ</td>
            <td><strong>行為自体が適法</strong></td>
            <td>正規集金は本来適法な行為、内心の不法は動機に過ぎない</td>
            <td>事後の業務上横領罪(253条)</td>
          </tr>
          <tr>
            <td>エ</td>
            <td><strong>実行の着手なし</strong></td>
            <td>放火は予備段階、人に対する欺罔行為がまだ開始されていない</td>
            <td>放火罪(109条2項等)のみ</td>
          </tr>
          <tr>
            <td>オ</td>
            <td><strong>他罪に包含・吸収</strong></td>
            <td>通貨の本来的支払手段性＋152条均衡論で偽造通貨行使罪に吸収</td>
            <td>偽造通貨行使罪(148条2項)のみ</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>記述</th><th>事案</th><th>結論</th><th>判例</th><th>解説へ</th></tr>
        </thead>
        <tbody>
          <tr>
            <td>ア</td>
            <td>背任的欺罔→財物交付</td>
            <td><strong>Ⅰ</strong> 詐欺罪のみ</td>
            <td><a class="ref-case" id="ref-case-saiko-s28-5-8-006" href="#case-saiko-s28-5-8">最判昭28.5.8</a></td>
            <td><a href="#choice-1">→ 記述ア</a></td>
          </tr>
          <tr class="row-key">
            <td><strong>イ</strong></td>
            <td><strong>脅迫＋虚偽→畏怖→交付</strong></td>
            <td><strong>Ⅲ 詐欺不成立</strong></td>
            <td><a class="ref-case" id="ref-case-saiko-s24-2-8-006" href="#case-saiko-s24-2-8">最判昭24.2.8</a></td>
            <td><a href="#choice-2">→ 記述イ</a></td>
          </tr>
          <tr>
            <td>ウ</td>
            <td>集金員の不法意図秘匿集金</td>
            <td><strong>Ⅲ</strong> 詐欺不成立</td>
            <td><a class="ref-case" id="ref-case-tokyo-s28-6-12-006" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a></td>
            <td><a href="#choice-3">→ 記述ウ</a></td>
          </tr>
          <tr class="row-key">
            <td><strong>エ</strong></td>
            <td><strong>保険金詐取目的の放火</strong></td>
            <td><strong>Ⅲ 詐欺不成立</strong></td>
            <td><a class="ref-case" id="ref-case-daihan-m5-12-12-004" href="#case-daihan-m5-12-12">大判明5.12.12</a></td>
            <td><a href="#choice-4">→ 記述エ</a></td>
          </tr>
          <tr>
            <td>オ</td>
            <td>偽造通貨行使で財物騙取</td>
            <td><strong>Ⅲ</strong> 詐欺不成立</td>
            <td><a class="ref-case" id="ref-case-daihan-m43-6-30-021" href="#case-daihan-m43-6-30">大判明43.6.30</a></td>
            <td><a href="#choice-5">→ 記述オ</a></td>
          </tr>
        </tbody>
      </table>
    </div>
    <p style="font-size:.92em; margin-top:8px;">正答肢3は <strong>「イⅢ─エⅢ」</strong>。5 記述中4 つが結論Ⅲなので、判例の事案・法理を正確に押さえていれば各肢の結論Ⅲ／Ⅰ を判定でき、組合せ <strong>イⅢ・エⅢ</strong> に到達できる。<a class="ref-stat" id="ref-law-247-020" href="#law-247">247条</a>・<a class="ref-stat" id="ref-law-249-020" href="#law-249">249条</a>・<a class="ref-stat" id="ref-law-253-020" href="#law-253">253条</a>・<a class="ref-stat" id="ref-law-109-020" href="#law-109">109条2項</a>・<a class="ref-stat" id="ref-law-148-006" href="#law-148">148条2項</a>の各構成要件を一度に総点検する好問題。</p>
  ...
  <section class="section" id="c-3">
    ...
    <p>本問の論点は<strong>刑法総論・各論を縦断する</strong>形で他分野と連動する。とりわけ <strong>罪数論</strong>・<strong>実行着手論</strong>・<strong>財産犯三角形</strong> の3 領域が直接の理論基盤を提供する。共通点・相違点・答案展開・関連条文判例の4 軸で整理する。</p>

    <div class="cross-grid">
      <div class="cross-card">
        <h4><span class="cc-label">刑法総論</span>罪数論──法条競合・観念的競合・包含関係</h4>
        <div class="cc-row"><span class="cc-key">共通点</span>同一の事実が複数の構成要件に該当する場合の処理という共通の対象。「記述ア（背任を包含）」「記述オ（偽造通貨行使に包含）」「結論Ⅱ（双方成立）」のいずれも罪数論の判断構造の上に立つ。</div>
        <div class="cc-row"><span class="cc-key">相違点</span><strong>法条競合（吸収関係・特別関係）</strong>＝1 個の罪のみ成立（成立段階の問題）。<strong>観念的競合（54条1項）</strong>＝複数の罪が成立しつつ刑のみ重い方で処断（科刑段階の問題）。本問の記述ア・オはいずれも法条競合（吸収）の例。</div>
        <div class="cc-row"><span class="cc-key">答案展開</span>記述ア「背任行為が詐欺の観念に当然包含される」、記述オ「152条との均衡から詐欺罪併存を否定」──いずれも<strong>立法者意思に基づく罪数判断</strong>が答案の核。包含関係を主張する場合「より重い特別罪が一般罪を吸収する」というロジックを示すと得点。</div>
        <div class="cc-row"><span class="cc-key">関連条文</span>54条1項（観念的競合・牽連犯）／<a class="ref-case" id="ref-case-saiko-s28-5-8-007" href="#case-saiko-s28-5-8">最判昭28.5.8</a>（背任包含）／<a class="ref-case" id="ref-case-daihan-m43-6-30-003" href="#case-daihan-m43-6-30">大判明43.6.30</a>（偽造通貨行使に包含）</div>
      </div>

      <div class="cross-card">
        <h4><span class="cc-label">刑法総論</span>実行の着手論──主観・客観の交錯</h4>
        <div class="cc-row"><span class="cc-key">共通点</span>「行為者が主観的に最終目的をもって動いている場面で、客観的にどの時点で実行の着手があるか」という共通の問題構造。本問記述エ（保険金詐取目的の放火）はこの論点の古典的事例。</div>
        <div class="cc-row"><span class="cc-key">相違点</span>判例の<strong>「構成要件該当行為の開始時」基準</strong>は、詐欺罪では<span class="case-emphasis freq-mid">「人に対する欺罔行為の開始」</span>と具体化される。窃盗罪では「占有侵害の現実的危険を生じさせた時」（最判昭40.3.9：物色行為の開始）と具体化される。罪により実行着手のメルクマールが異なる。</div>
        <div class="cc-row"><span class="cc-key">答案展開</span>「Xは保険金詐取目的で放火した」とあれば、即座に<strong>「詐欺罪の実行着手は欺罔行為の開始時。放火段階では人に対する欺罔がない以上、未だ実行の着手はない」</strong>と論じる。判例（<a class="ref-case" id="ref-case-daihan-m5-12-12-005" href="#case-daihan-m5-12-12">大判明5.12.12</a>）の射程内。</div>
        <div class="cc-row"><span class="cc-key">関連判例</span><a class="ref-case" id="ref-case-daihan-m5-12-12-006" href="#case-daihan-m5-12-12">大判明5.12.12</a>（詐欺着手）／最判昭40.3.9（窃盗着手）／最決平16.3.22（特殊詐欺の電話着手）</div>
      </div>

      <div class="cross-card">
        <h4><span class="cc-label">刑法各論</span>財産犯体系──詐欺・恐喝・横領・背任の三角形</h4>
        <div class="cc-row"><span class="cc-key">共通点</span>客体は財産。客観的には他人から財物・利益が移転する事象。本問の記述ア・イ・ウ・オは、いずれも「財物移転」が結果として発生している事案。</div>
        <div class="cc-row"><span class="cc-key">相違点</span><strong>欺罔・畏怖・占有・任務違背</strong>の4 つのメルクマールで区別される。詐欺＝欺罔→錯誤／恐喝＝畏怖／横領＝自己占有他人物の領得／背任＝事務処理者の任務違背。本問記述イ・ウは詐欺と恐喝・横領の境界判断。</div>
        <div class="cc-row"><span class="cc-key">答案展開</span>記述イ「虚偽部分は畏怖の一材料に過ぎず、究極的原因は畏怖」(<a class="ref-case" id="ref-case-saiko-s24-2-8-007" href="#case-saiko-s24-2-8">最判昭24.2.8</a>)、記述ウ「正規集金は適法、不法意図は動機に過ぎない」(<a class="ref-case" id="ref-case-tokyo-s28-6-12-007" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a>)。両者とも<strong>「形式的には欺罔があるように見えるが、実質的には別罪の枠組み」</strong>という分析が答案の決まり手。</div>
        <div class="cc-row"><span class="cc-key">関連条文</span><a class="ref-stat" id="ref-law-246-011" href="#law-246">246条</a>／<a class="ref-stat" id="ref-law-249-003" href="#law-249">249条</a>／<a class="ref-stat" id="ref-law-253-003" href="#law-253">253条</a>／<a class="ref-stat" id="ref-law-247-003" href="#law-247">247条</a>／<a class="ref-case" id="ref-case-saiko-s24-2-8-008" href="#case-saiko-s24-2-8">最判昭24.2.8</a>／<a class="ref-case" id="ref-case-tokyo-s28-6-12-008" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a></div>
      </div>
    </div>
  ...
  <section class="section" id="c-4">
    ...
    <h2 class="section-title"><span class="sec-icon">⚔</span>C-4 学説対立──罪数・着手・究極原因論</h2>

    <div class="key-phrase-box">
      <span class="kp-strong">本問関連の対立軸は4 本</span>──①詐欺と背任の関係（<strong>包含説</strong> vs 観念的競合説）、②虚偽脅迫の罪名（<strong>恐喝罪説（究極原因論）</strong> vs 詐欺・恐喝両罪説）、③詐欺の実行着手時期（<strong>欺罔行為開始説</strong> vs 結果発生危険説）、④偽造通貨行使と詐欺の関係（<strong>包含説（152条均衡）</strong> vs 観念的競合説）。判例はいずれも前者を採用。
    </div>

    <h3>① 詐欺罪と背任罪の関係（記述ア・結論Ⅰ）</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>学説</th><th>結論</th><th>論拠</th><th>判例</th></tr>
        </thead>
        <tbody>
          <tr class="row-key">
            <td><strong>詐欺包含説（判例・通説）</strong></td>
            <td><span class="ok-cell">詐欺罪のみ成立。背任罪は別個に成立しない</span></td>
            <td>①背任行為は<strong>詐欺の観念に当然包含される</strong>。②詐欺罪の方が法定刑（10年以下）が重く、背任罪（5年以下）を吸収する。③同一の財物に対する二重評価を避ける。</td>
            <td><a class="ref-case" id="ref-case-saiko-s28-5-8-003" href="#case-saiko-s28-5-8">最判昭28.5.8</a></td>
          </tr>
          <tr>
            <td>観念的競合説（少数説）</td>
            <td><span class="ng-cell">両罪成立。54条1項で詐欺罪の刑に処断</span></td>
            <td>①保護法益が異なる（詐欺＝個人財産、背任＝本人の財産＋信任）。②法条競合とまで言える特別関係はない。</td>
            <td>判例不採用</td>
          </tr>
        </tbody>
      </table>
    ...
    <h3>② 脅迫文言に虚偽が含まれる場合の罪名（記述イ・結論Ⅲ）</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>学説</th><th>結論</th><th>論拠</th><th>判例</th></tr>
        ...
        <tbody>
          <tr class="row-key">
            <td><strong>恐喝罪説（究極原因論・判例・通説）</strong></td>
            <td><span class="ok-cell">恐喝罪のみ成立、詐欺罪不成立</span></td>
            <td>①虚偽は畏怖の<strong>一材料に過ぎず</strong>、財物交付の<strong>究極的原因</strong>は畏怖。②詐欺罪と恐喝罪は欺罔と畏怖という別の機序を要件とし、本問では恐喝の機序が貫徹する。</td>
            <td><a class="ref-case" id="ref-case-saiko-s24-2-8-003" href="#case-saiko-s24-2-8">最判昭24.2.8</a></td>
          </tr>
          <tr>
            <td>詐欺・恐喝両罪説（少数説）</td>
            <td><span class="ng-cell">両罪成立（観念的競合）</span></td>
            <td>①虚偽部分が独立に錯誤を生じさせ財物交付に寄与している。②両機序が並存する。</td>
            <td>判例不採用</td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="warning">
      <p><strong>究極原因論の含意</strong>：判例は「虚偽が事実上の弱点をついて畏怖を強化した場合でも、本質は畏怖による財物交付なので恐喝罪のみ」とする。<span class="exam-mark freq-mid">「欺罔」と「畏怖」が並存しているように見えても、最終的に何が財物交付を引き起こしたかで罪名を一義的に決める</span>のが判例の立場。</p>
    </div>

    <h3>③ 詐欺罪の実行着手時期（記述エ・結論Ⅲ）</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>学説</th><th>着手時期</th><th>論拠</th><th>本問記述エ</th></tr>
        </thead>
        <tbody>
          <tr class="row-key">
            <td><strong>欺罔行為開始説（判例・通説）</strong></td>
            <td>人に対する欺罔行為を開始したとき</td>
            <td>①構成要件該当行為（欺罔）の開始が着手の客観的標準。②主観に詐欺意思があるだけでは不十分。</td>
            <td><span class="ok-cell">放火段階では着手なし→詐欺不成立。<a class="ref-case" id="ref-case-daihan-m5-12-12-007" href="#case-daihan-m5-12-12">大判明5.12.12</a></span></td>
          </tr>
          <tr>
            <td>結果発生危険説（少数説）</td>
            <td>財物交付の現実的危険を生じさせる行為時</td>
            <td>①未遂犯処罰の保護法益侵害危険発生時。②着手時期を客観的危険性で判断。</td>
            <td>結論は判例と同じ（放火段階では危険発生なし）</td>
          </tr>
        </tbody>
      </table>
    </div>

    <h3>④ 偽造通貨行使罪と詐欺罪の関係（記述オ・結論Ⅲ）</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>学説</th><th>結論</th><th>論拠</th><th>判例</th></tr>
        ...
        <tbody>
          <tr class="row-key">
            <td><strong>包含説（152条均衡論・判例・通説）</strong></td>
            <td><span class="ok-cell">偽造通貨行使罪のみ成立、詐欺罪不成立</span></td>
            <td>①通貨は本来的支払手段。偽造通貨を行使すれば必然的に他人の財物を取得する関係にあり、立法者は<strong>偽造通貨行使罪の刑を重くする</strong>ことで両者を一体評価した。②<a class="ref-stat" id="ref-law-148-007" href="#law-148">152条</a>収得後知情行使罪は罰金・科料で<strong>極めて軽く</strong>、ここに詐欺罪を併存させると<strong>152条の軽処罰立法趣旨が没却</strong>される。152条と148条の整合性を確保するため、両条とも詐欺罪を併存させない。</td>
            <td><a class="ref-case" id="ref-case-daihan-m43-6-30-004" href="#case-daihan-m43-6-30">大判明43.6.30</a></td>
          </tr>
          <tr>
            <td>観念的競合説（少数説）</td>
            <td><span class="ng-cell">両罪成立。54条1項で偽造通貨行使罪の刑に処断</span></td>
            <td>①保護法益が異なる（偽造通貨行使＝通貨に対する公共の信用、詐欺＝個人財産）。②欺罔→錯誤→交付の機序が独立に充足されている。</td>
            <td>判例不採用</td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="cross-link">
      <p><strong>📌 152条均衡論の独自性</strong>：本論点は<span class="case-emphasis freq-mid">「下位条文との整合性から上位条文の解釈を導く」</span>類型の立法者意思に基づく解釈論。152条が軽く設定されている事実から逆算して、148条についても詐欺罪併存を否定する。論文式で論じる際は「152条との均衡」というキーワードを必ず明示すると説得力が増す。</p>
    </div>
  ...
  <section class="section" id="c-5">
    ...
    <h2 class="section-title"><span class="sec-icon">🗺</span>C-5 総合フローチャート──詐欺罪と他罪の判定戦略</h2>

    <div class="key-phrase-box">
      <span class="kp-strong">5 段階の判断プロセス</span>──①欺罔行為の存在→②人に対する欺罔の開始（着手）→③錯誤・処分・移転の連鎖→④他罪との罪数関係→⑤結論Ⅰ／Ⅱ／Ⅲ の決定。各段階のどこで止まるかによって結論Ⅰ／Ⅲ が分岐する。
    </div>

    <div class="figure-wrap">
      <svg viewBox="0 0 720 760" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="詐欺罪と他罪の判定フローチャート">
        <defs>
        ...
        <text class="steptitle" x="200" y="64">人に対する欺罔行為があるか</text>
        <text class="stepdesc" x="200" y="84">「人」を欺いて錯誤に陥らせる行為か（家屋・カードは対象外）</text>

        <line class="arrow" x1="360" y1="100" x2="360" y2="125"/>
        <text class="stepyes" x="370" y="118">YES</text>

        <rect class="stepbox" x="180" y="125" width="360" height="80" rx="6"/>
        <text class="stepnum" x="200" y="149">STEP 2</text>
        <text class="steptitle" x="200" y="169">行為自体が違法か（適法集金等は脱落）</text>
        <text class="stepdesc" x="200" y="189">「動機の不法」だけでは詐欺不成立（記述ウ）</text>

        <line class="arrow" x1="360" y1="205" x2="360" y2="230"/>

        <rect class="stepbox" x="180" y="230" width="360" height="80" rx="6"/>
        <text class="stepnum" x="200" y="254">STEP 3</text>
        <text class="steptitle" x="200" y="274">欺罔が究極的な交付原因か</text>
        <text class="stepdesc" x="200" y="294">虚偽が「畏怖の一材料」に過ぎないなら詐欺不成立→恐喝（記述イ）</text>

        <line class="arrow" x1="360" y1="310" x2="360" y2="335"/>

        <rect class="stepbox" x="180" y="335" width="360" height="100" rx="6"/>
        <text class="stepnum" x="200" y="359">STEP 4</text>
        <text class="steptitle" x="200" y="379">罪数関係を判定</text>
        <text class="stepdesc" x="200" y="399">他罪を包含するか／他罪に吸収されるか／観念的競合か</text>
        <text class="stepdesc" x="200" y="419">記述ア（背任を包含＝Ⅰ）／記述オ（偽造通貨行使に包含される＝Ⅲ）</text>

        <line class="arrow" x1="360" y1="435" x2="360" y2="460"/>

        <rect class="stepbox" x="180" y="460" width="360" height="100" rx="6"/>
        <text class="stepnum" x="200" y="484">STEP 5</text>
        <text class="steptitle" x="200" y="504">実行の着手時期を確認</text>
        <text class="stepdesc" x="200" y="524">予備段階で止まれば詐欺不成立（記述エ：放火→請求未だ）</text>
        <text class="stepdesc" x="200" y="544">→ 着手なしなら結論Ⅲ</text>

        <rect class="branch" x="20" y="40" width="140" height="60" rx="4"/>
        <text class="branchtxt" x="30" y="58">NO（家屋・物への</text>
        <text class="branchtxt" x="30" y="76">放火・偽造のみ等）</text>
        <text class="branchtxt" x="30" y="94">→ 結論Ⅲ（記述エ）</text>

        <rect class="branch" x="560" y="140" width="140" height="60" rx="4"/>
        <text class="branchtxt" x="570" y="158">NO（正規集金</text>
        <text class="branchtxt" x="570" y="176">など適法行為）</text>
        <text class="branchtxt" x="570" y="194">→ 結論Ⅲ（記述ウ）</text>

        <rect class="branch" x="20" y="245" width="140" height="60" rx="4"/>
        <text class="branchtxt" x="30" y="263">NO（虚偽は畏怖</text>
        <text class="branchtxt" x="30" y="281">の一材料）</text>
        <text class="branchtxt" x="30" y="299">→ 結論Ⅲ（記述イ）</text>

        <rect class="branch" x="560" y="345" width="140" height="80" rx="4"/>
        <text class="branchtxt" x="570" y="363">包含するケース</text>
        <text class="branchtxt" x="570" y="381">→ 結論Ⅰ（記述ア）</text>
        <text class="branchtxt" x="570" y="403">包含されるケース</text>
        <text class="branchtxt" x="570" y="421">→ 結論Ⅲ（記述オ）</text>

        <rect x="180" y="620" width="360" height="120" rx="6" fill="#5a1a30" stroke="#dc4d71" stroke-width="2"/>
        <text x="360" y="648" text-anchor="middle" font-family="Shippori Mincho B1,serif" font-size="14" font-weight="700" fill="#fff">本問の処理結果</text>
        <text x="360" y="672" text-anchor="middle" font-family="Noto Sans JP,sans-serif" font-size="12" fill="#fff">ア=Ⅰ ／ イ=Ⅲ ／ ウ=Ⅲ ／ エ=Ⅲ ／ オ=Ⅲ</text>
        <text x="360" y="696" text-anchor="middle" font-family="Noto Sans JP,sans-serif" font-size="12" fill="#fff">「正しい組合せ」＝ 肢3 <tspan font-weight="700">イⅢ─エⅢ</tspan></text>
        <text x="360" y="720" text-anchor="middle" font-family="Noto Sans JP,sans-serif" font-size="11" fill="#fff">他の肢は ア・ウ・オの結論が誤っているか組合せが噛み合わず脱落</text>

        <line class="arrow" x1="360" y1="560" x2="360" y2="620"/>
      </svg>
      <p class="figure-caption">図2：詐欺罪と他罪の成否 5 段階判断フローチャート</p>
    </div>

    <h3>運用上の鉄則</h3>
    <ul class="lead-list">
      <li><strong>STEP 1 で 「人」 を意識</strong> 詐欺罪の欺罔は<span class="exam-mark freq-mid">「人に対する」欺罔</span>であり、物（家屋、保険契約書類等）への作用は欺罔ではない。記述エで「保険金詐取目的」だけでは着手にならない理由はここにある。</li>
      <li><strong>STEP 2 で 「行為自体の適法性」 を切り分け</strong> 記述ウのような正規集金は<span class="exam-mark freq-mid">客観的に適法行為</span>。内心の不法（あとで横領する気）は<strong>動機の不法に過ぎず</strong>、欺罔行為を違法ならしめない。これを混同しないことが鍵。</li>
      <li><strong>STEP 3 で 「究極原因」 を見極め</strong> 脅迫＋虚偽の場合（記述イ）、判例は虚偽を<span class="exam-mark freq-mid">畏怖の一材料</span>と位置付け、究極的原因＝畏怖と評価する。「両方並存」ではなく「畏怖が主、虚偽が従」と決めるのが判例の論理。</li>
      <li><strong>STEP 4 の罪数判定で 「包含する／される」 を区別</strong> 記述ア（詐欺が背任を包含＝Ⅰ）と記述オ（詐欺が偽造通貨行使に包含される＝Ⅲ）は<strong>方向が逆</strong>。法定刑の重さと立法者意思から「より重い罪が軽い罪を吸収する」と覚える。</li>
      <li><strong>STEP 5 で 「主観でなく客観」 を見る</strong> 記述エでは主観に「保険金詐取目的」があるが、客観的には<span class="case-emphasis freq-mid">放火という他罪の構成要件該当行為だけ</span>。詐欺罪の構成要件該当行為（欺罔）が未だ着手されていない以上、詐欺罪の実行着手はない。</li>
    </ul>
  ...
  <section class="section" id="c-6">
    ...
    <h3>出題頻度マップ（詐欺罪と他罪の成否）</h3>
    <div class="cmp-table-wrap">
      <table>
        <thead>
          <tr><th>論点</th><th>出題頻度</th><th>代表年度</th><th>本問との関係</th></tr>
        </thead>
        <tbody>
          <tr class="row-key"><td>詐欺罪と背任罪の関係（包含論）</td><td><span class="exam-mark freq-high">🔴 頻出</span></td><td>司R1-16(本問)・予H22・H30</td><td>本問記述ア</td></tr>
          <tr class="row-key"><td>脅迫＋虚偽の罪名（究極原因論）</td><td><span class="exam-mark freq-high">🔴 頻出</span></td><td>司H17・H24・予H20・予R2</td><td>本問記述イ</td></tr>
          <tr><td>集金員の不法意図と詐欺</td><td><span class="exam-mark freq-mid">🟡 中頻度</span></td><td>司H15・H22・予H25</td><td>本問記述ウ</td></tr>
          <tr class="row-key"><td>保険金詐取目的の放火と着手</td><td><span class="exam-mark freq-high">🔴 頻出</span></td><td>司H18・H23・H29・予H24</td><td>本問記述エ・判例の射程</td></tr>
          <tr><td>偽造通貨行使と詐欺罪</td><td><span class="exam-mark freq-mid">🟡 中頻度</span></td><td>司H20・予H21・予H28</td><td>本問記述オ・152条均衡</td></tr>
          <tr><td>特殊詐欺の実行着手時期</td><td><span class="exam-mark freq-high">🔴 頻出</span></td><td>司R2・R4・予R3</td><td>本問記述エの応用（最決平16）</td></tr>
          <tr><td>2項詐欺と利益移転</td><td><span class="exam-mark freq-mid">🟡 中頻度</span></td><td>司H19・H27・予H23</td><td>本問の射程外だが詐欺罪一般論</td></tr>
        </tbody>
      </table>
    </div>
    ...
    <h3>出題傾向の分析</h3>
    <ul class="lead-list">
      <li><strong>「実行の着手時期」は超頻出</strong>本問記述エ（保険金詐取目的の放火）は古典的判例（<a class="ref-case" id="ref-case-daihan-m5-12-12-008" href="#case-daihan-m5-12-12">大判明5.12.12</a>）の射程内。近年では<span class="case-emphasis freq-high">特殊詐欺</span>（オレオレ詐欺・架け子の電話）の着手時期（最決平16.3.22）にも応用されている。詐欺罪の着手＝<span class="ron-mark freq-high">人に対する欺罔行為の開始</span>という原則を理解しているかが必ず問われる。</li>
      <li><strong>「究極原因論」も超頻出</strong>本問記述イ（<a class="ref-case" id="ref-case-saiko-s24-2-8-010" href="#case-saiko-s24-2-8">最判昭24.2.8</a>）の理論は、論文式試験での恐喝罪・詐欺罪の区別論で繰り返し問われる。「畏怖と錯誤が並存する場合の処理」を一行で説明できる必要あり。</li>
      <li><strong>「罪数論」は択一・論文両形式で出る</strong>記述ア（詐欺と背任）・記述オ（詐欺と偽造通貨行使）はいずれも法条競合（吸収関係）の典型例。<span class="exam-mark freq-mid">「より重い罪が軽い罪を吸収する」</span>原則を覚えていれば即答可能。</li>
      <li><strong>本問形式（記述×結論の組合せ）の利点</strong>5 つの記述それぞれについて結論Ⅰ／Ⅱ／Ⅲ を判定する形式は、<strong>判例の射程・法理を網羅的に確認</strong>するために設計されている。1 つの記述だけ正確に判定できても他で誤ると組合せ全体が不正解になるため、<span class="case-emphasis freq-mid">判例 5本（最判昭28.5.8・最判昭24.2.8・東京高判昭28.6.12・大判明5.12.12・大判明43.6.30）を全件知っている</span>ことが要求される。</li>
    </ul>

    <h3>関連問題・参考</h3>
    <ul class="lead-list">
      <li><strong>司H29-12</strong>保険金詐取目的の建物焼損──本問記述エの拡張形。保険会社への保険金請求書提出時に詐欺罪の実行着手があるかを問う。</li>
      <li><strong>司R2-15</strong>特殊詐欺（オレオレ詐欺）の架け子の電話と実行着手──現代的応用論点。最決平16.3.22の射程と本問記述エの古典判例（<a class="ref-case" id="ref-case-daihan-m5-12-12-009" href="#case-daihan-m5-12-12">大判明5.12.12</a>）の比較が問われる。</li>
      <li><strong>予H20-13</strong>脅迫文言中の虚偽と恐喝罪──本問記述イと同論点。究極原因論を答案で展開する練習問題。</li>
      <li><strong>予H21-14</strong>偽造通貨行使と詐欺罪の関係──本問記述オと同論点。152条均衡論を論文形式で論じる練習問題。</li>
    </ul>

    <div class="back-to-top"><a href="#top">↑ ページ先頭へ</a></div>
  </section>

  <!-- =============== C-7 三層構造記憶＋final-answer =============== -->
  <section class="section" id="c-7">
    ...
    <div class="key-phrase-box">
      <span class="kp-strong">本セクションは三層×5項目＝全15項目</span>──<strong>A層</strong>＝各記述ア〜オの核心命題（試験直前必須）／<strong>B層</strong>＝詐欺罪体系を貫く5本の柱（週次サイクル）／<strong>S層</strong>＝本問関連の補強知識（直前2週間）。各項目は「<span class="kp-strong">結論的タイトル＋本文＋mem-hint（判例／条文／該当記述の3層構造）</span>」で構成。
    </div>
    ...
    <div class="memory-list">
      <div class="memory-item priority-a">
        ...
        <div class="mem-body">
          <span class="mem-title">記述ア：背任的欺罔→財物交付は詐欺のみ（背任を包含）</span>
          他人の事務処理者が任務に背いて欺罔行為をし錯誤に陥らせて財物を交付させた場合、背任行為は<strong>詐欺罪の観念に当然包含される</strong>ため、別個に背任罪は成立せず、<a class="ref-stat" id="ref-law-246-012" href="#law-246">246条1項詐欺罪のみ</a>が成立する。法定刑の重さ（詐欺10年≧背任5年）と一物一行為の評価から導かれる。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-saiko-s28-5-8-004" href="#case-saiko-s28-5-8">最判昭28.5.8</a> ／ 条文：<a class="ref-stat" id="ref-law-247-004" href="#law-247">246条・247条</a> ／ 該当記述：<a href="#choice-1">記述ア（結論Ⅰ）</a></span>
        </div>
      </div>

      <div class="memory-item priority-a">
        <span class="priority-badge priority-a">A2</span>
        <div class="mem-body">
          <span class="mem-title">記述イ：脅迫＋虚偽→畏怖→交付は恐喝のみ（究極原因論）</span>
          恐喝の脅迫文言中に虚偽部分があり、それが畏怖の<strong>一材料となって</strong>、その畏怖の結果として財物が交付された場合、判例は<strong>究極的原因は畏怖</strong>と評価し、<a class="ref-stat" id="ref-law-249-004" href="#law-249">249条恐喝罪のみ</a>が成立し、詐欺罪は成立しないとする。虚偽部分は補助的役割に過ぎず詐欺罪の独立成立を基礎づけない。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-saiko-s24-2-8-004" href="#case-saiko-s24-2-8">最判昭24.2.8</a> ／ 条文：<a class="ref-stat" id="ref-law-246-013" href="#law-246">246条・249条</a> ／ 該当記述：<a href="#choice-2">記述イ（結論Ⅲ・本問正解の一部）</a></span>
        </div>
      </div>

      <div class="memory-item priority-a">
        <span class="priority-badge priority-a">A3</span>
        <div class="mem-body">
          <span class="mem-title">記述ウ：集金員の不法意図秘匿は詐欺なし（動機の不法）</span>
          新聞販売店から集金業務を委託された集金員が、集金した購読料を自己の用途に費消するつもりでありながら、これを秘して正規の手続・方式で集金した場合、<strong>集金行為自体は適法</strong>で、内心の不法意図は<strong>「単なる動機の不法」</strong>に過ぎず、集金行為を違法ならしめない。よって購読者に対する詐欺罪は不成立。事後の費消行為が<a class="ref-stat" id="ref-law-253-004" href="#law-253">253条業務上横領罪</a>を構成。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-tokyo-s28-6-12-009" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a> ／ 条文：<a class="ref-stat" id="ref-law-246-014" href="#law-246">246条・253条</a> ／ 該当記述：<a href="#choice-3">記述ウ（結論Ⅲ）</a></span>
        </div>
      </div>

      <div class="memory-item priority-a">
        <span class="priority-badge priority-a">A4</span>
        <div class="mem-body">
          <span class="mem-title">記述エ：放火段階では詐欺の着手なし</span>
          保険金詐取の目的で自己所有の家屋に放火しただけでは、<strong>人に対する欺罔行為がまだ開始されていない</strong>ため詐欺罪の実行の着手はない。判例は、保険会社に対する保険金請求の段階で初めて欺罔行為が開始され、詐欺罪の実行着手が認められるとする。<a class="ref-stat" id="ref-law-109-004" href="#law-109">109条2項放火罪</a>のみが成立する余地。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-daihan-m5-12-12-010" href="#case-daihan-m5-12-12">大判明5.12.12</a> ／ 条文：<a class="ref-stat" id="ref-law-246-015" href="#law-246">246条・109条2項</a> ／ 該当記述：<a href="#choice-4">記述エ（結論Ⅲ・本問正解の一部）</a></span>
        </div>
      </div>

      <div class="memory-item priority-a">
        <span class="priority-badge priority-a">A5</span>
        <div class="mem-body">
          <span class="mem-title">記述オ：偽造通貨行使に詐欺は包含される（152条均衡論）</span>
          偽造通貨を売買代金として行使して財物を取得した場合、判例は<strong>偽造通貨行使罪に詐欺罪が包含される</strong>とし、別個の詐欺罪成立を否定する（<a class="ref-stat" id="ref-law-148-008" href="#law-148">148条2項</a>のみ）。論拠は ①通貨の本来的支払手段性＋148条2項の重い法定刑、および ②<a class="ref-stat" id="ref-law-148-009" href="#law-148">152条</a>収得後知情行使罪との均衡（同条の軽い処罰を没却しないため）。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-daihan-m43-6-30-005" href="#case-daihan-m43-6-30">大判明43.6.30</a> ／ 条文：<a class="ref-stat" id="ref-law-148-010" href="#law-148">148条2項・152条・246条</a> ／ 該当記述：<a href="#choice-5">記述オ（結論Ⅲ）</a></span>
        </div>
      </div>
    </div>
    ...
    <div class="memory-list">
      <div class="memory-item priority-b">
        ...
        <div class="mem-body">
          <span class="mem-title">詐欺罪の4 段階因果連鎖</span>
          詐欺罪（<a class="ref-stat" id="ref-law-246-016" href="#law-246">246条1項・2項</a>）の構成要件は ①<strong>欺罔行為</strong>→②錯誤→③処分行為→④財物・利益の移転、の 4 段階の因果連鎖を要件とする。各段階が客観的に充足されているかを順に確認するのが基本。本問記述エは①が未着手、記述ウは①の対象が「行為自体適法」のため脱落。
          <span class="mem-hint">▶ 条文：<a class="ref-stat" id="ref-law-246-017" href="#law-246">246条</a> ／ 体系：財産犯の基本構造</span>
        </div>
      </div>

      <div class="memory-item priority-b">
        <span class="priority-badge priority-b">B2</span>
        <div class="mem-body">
          <span class="mem-title">詐欺罪の実行着手＝「人に対する欺罔行為の開始」</span>
          詐欺罪の実行の着手時期は<strong>「行為者が詐欺の意思で人に対し欺罔行為を開始したとき」</strong>。物への作用（放火・偽造）は予備段階に過ぎず、人を欺く行為が開始されない限り着手とならない。特殊詐欺（オレオレ詐欺）の場合、架け子の電話が欺罔行為の開始時として実行着手と評価される（最決平16.3.22）。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-daihan-m5-12-12-011" href="#case-daihan-m5-12-12">大判明5.12.12</a>／最決平16.3.22 ／ 全体構造：実行着手論</span>
        </div>
      </div>

      <div class="memory-item priority-b">
        <span class="priority-badge priority-b">B3</span>
        <div class="mem-body">
          <span class="mem-title">詐欺罪と他罪の罪数関係（包含・吸収）</span>
          詐欺罪と他罪が形式的に同時成立し得る場合、判例は<strong>立法者意思に基づく罪数判定</strong>を行う。①詐欺が他罪を包含するケース（背任を包含＝記述ア）、②詐欺が他罪に包含されるケース（偽造通貨行使に包含＝記述オ）、③観念的競合（54条1項）として両罪併存するケース（結論Ⅱ）に分類される。法定刑の重さと立法者意思が判別の鍵。
          <span class="mem-hint">▶ 条文：54条1項／<a class="ref-stat" id="ref-law-246-018" href="#law-246">246条</a> ／ 全体構造：罪数論</span>
        </div>
      </div>

      <div class="memory-item priority-b">
        <span class="priority-badge priority-b">B4</span>
        <div class="mem-body">
          <span class="mem-title">究極原因論（畏怖 vs 錯誤）</span>
          脅迫＋虚偽が混在する場合、判例は<strong>究極的原因が何かで罪名を一義的に決定</strong>する。財物交付の究極的原因が畏怖なら恐喝罪のみ、錯誤なら詐欺罪のみ。「両罪併存」ではなく「一方が主、他方が従」という構造を取るのが判例の特徴。本問記述イはこの理論の典型適用例。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-saiko-s24-2-8-012" href="#case-saiko-s24-2-8">最判昭24.2.8</a> ／ 全体構造：詐欺と恐喝の区別</span>
        </div>
      </div>

      <div class="memory-item priority-b">
        <span class="priority-badge priority-b">B5</span>
        <div class="mem-body">
          <span class="mem-title">動機の不法と行為の違法性は別個</span>
          客観的に適法な行為であれば、行為者の内心に不法な意図があっても<strong>その行為自体は違法とならない</strong>。本問記述ウの正規集金行為は、後で横領する内心があっても集金行為自体は適法。動機の不法は<strong>事後の領得行為（横領罪）</strong>を構成するに過ぎない。客観的構成要件該当性と主観的犯意の区別を明確に。
          <span class="mem-hint">▶ 判例：<a class="ref-case" id="ref-case-tokyo-s28-6-12-010" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a> ／ 全体構造：違法性論</span>
        </div>
      </div>
    </div>
    ...
    <div class="memory-list">
      <div class="memory-item priority-c">
        ...
        <div class="mem-body">
          <span class="mem-title">背任罪（247条）の補充性</span>
          背任罪は「他人のためにその事務を処理する者が、自己若しくは第三者の利益を図り又は本人に損害を加える目的で、その任務に背く行為をし、本人に財産上の損害を加えた」場合に成立する（<a class="ref-stat" id="ref-law-247-005" href="#law-247">247条</a>）。詐欺罪と背任罪の構成要件が同時に充たされる場合は<strong>詐欺罪が優先</strong>。背任罪は他の財産犯（横領・詐欺）が成立しない場合の<span class="case-emphasis freq-mid">補充的構成要件</span>として機能する。
          <span class="mem-hint">▶ 条文：<a class="ref-stat" id="ref-law-247-006" href="#law-247">247条</a> ／ 該当記述：<a href="#choice-1">記述ア</a>と関連</span>
        </div>
      </div>

      <div class="memory-item priority-c">
        <span class="priority-badge priority-c">S2</span>
        <div class="mem-body">
          <span class="mem-title">恐喝罪（249条）の暴行・脅迫の程度</span>
          恐喝罪の暴行・脅迫は<strong>「畏怖させるに足りる程度」</strong>。強盗罪の「反抗を抑圧するに足りる程度」より弱い。詐欺罪の欺罔と恐喝罪の畏怖は性質が異なる機序であり、両方を要件とする犯罪類型は存在しない。記述イの「脅迫＋虚偽」は形式的には両機序が混在するが、判例は究極原因論で一方に決する。
          <span class="mem-hint">▶ 条文：<a class="ref-stat" id="ref-law-249-005" href="#law-249">249条</a> ／ 該当記述：<a href="#choice-2">記述イ</a>と関連</span>
        </div>
      </div>

      <div class="memory-item priority-c">
        <span class="priority-badge priority-c">S3</span>
        <div class="mem-body">
          <span class="mem-title">業務上横領罪（253条）の占有適法性</span>
          業務上横領罪は「業務上自己の占有する他人の物を横領した者」に成立する（<a class="ref-stat" id="ref-law-253-005" href="#law-253">253条</a>）。前提として<strong>占有が適法に始まっている</strong>必要があり、占有取得段階で詐欺・恐喝等の不法があれば横領罪ではなく当該罪が成立する。本問記述ウは集金段階の占有取得が適法（正規集金）なので、事後費消が業務上横領罪を構成。
          <span class="mem-hint">▶ 条文：<a class="ref-stat" id="ref-law-253-006" href="#law-253">253条</a> ／ 該当記述：<a href="#choice-3">記述ウ</a>と関連</span>
        </div>
      </div>

      <div class="memory-item priority-c">
        <span class="priority-badge priority-c">S4</span>
        <div class="mem-body">
          <span class="mem-title">放火罪の類型と公共危険発生要件</span>
          放火罪は ①108条（現住建造物等放火）、②109条1項（非現住建造物等放火・他人所有）、③109条2項（同・自己所有・公共の危険要件）、④110条（建造物以外）に分類される。本問記述エの「火災保険の付された自己所有の家屋」は109条2項に該当し、<strong>公共の危険が生じた場合</strong>に限り処罰される。詐欺罪との関係では、放火段階で着手前なので別個に検討。
          <span class="mem-hint">▶ 条文：108条〜110条／<a class="ref-stat" id="ref-law-109-005" href="#law-109">109条2項</a> ／ 該当記述：<a href="#choice-4">記述エ</a>と関連</span>
        </div>
      </div>

      <div class="memory-item priority-c">
        <span class="priority-badge priority-c">S5</span>
        <div class="mem-body">
          <span class="mem-title">152条収得後知情行使罪の趣旨と均衡論</span>
          <a class="ref-stat" id="ref-law-148-011" href="#law-148">152条</a>収得後知情行使罪は、偽造通貨と知らずに受け取った後にこれを行使する罪で、<strong>法定刑は通貨額面の3倍以下の罰金・科料</strong>と極めて軽い。立法者は「うっかり受け取った後の行使」を寛大に扱う趣旨。判例（<a class="ref-case" id="ref-case-daihan-m43-6-30-006" href="#case-daihan-m43-6-30">大判明43.6.30</a>）は、本来的支払手段である通貨を行使する場面に詐欺罪を併存させると152条の軽処罰趣旨が没却されるとし、148条2項の重い罪についても同様に詐欺罪併存を否定する均衡的解釈を採る。
          <span class="mem-hint">▶ 条文：<a class="ref-stat" id="ref-law-148-012" href="#law-148">148条2項・152条</a> ／ 該当記述：<a href="#choice-5">記述オ</a>と関連</span>
        </div>
      </div>
    </div>
    ...
    <div class="final-answer">
      <h3>🎯 正解</h3>
      <span class="answer-num">3</span>
      <p class="fa-summary"><strong>一文要約</strong>　<span class="ron-mark freq-high">「正しい組合せ」を問う形式で、判例の射程内の判定として正答はイⅢ─エⅢ</span>。各記述の結論は ア=Ⅰ（背任を包含）／<strong>イ=Ⅲ（虚偽は畏怖の一材料・恐喝のみ）</strong>／ウ=Ⅲ（正規集金は適法・動機の不法）／<strong>エ=Ⅲ（放火は実行着手にあらず）</strong>／オ=Ⅲ（偽造通貨行使に包含・152条均衡）。<strong>肢3「イⅢ─エⅢ」</strong>が正解。</p>
      <p>本問は<strong>古典的判例 5本</strong>を素材に、詐欺罪と他罪の関係を網羅的に問う基本問題。判例の核心法理を以下のキーワードで整理すると判定が速い──ア「<a class="ref-case" id="ref-case-saiko-s28-5-8-010" href="#case-saiko-s28-5-8">最判昭28.5.8</a>＝詐欺の観念に当然包含」／イ「<a class="ref-case" id="ref-case-saiko-s24-2-8-013" href="#case-saiko-s24-2-8">最判昭24.2.8</a>＝畏怖の一材料・恐喝のみ」／ウ「<a class="ref-case" id="ref-case-tokyo-s28-6-12-011" href="#case-tokyo-s28-6-12">東京高判昭28.6.12</a>＝動機の不法に過ぎず適法集金」／エ「<a class="ref-case" id="ref-case-daihan-m5-12-12-012" href="#case-daihan-m5-12-12">大判明5.12.12</a>＝請求時に着手」／オ「<a class="ref-case" id="ref-case-daihan-m43-6-30-007" href="#case-daihan-m43-6-30">大判明43.6.30</a>＝152条均衡論で吸収」。</p>
      <p>選択肢構造を見ると、肢1（アⅠ─イⅡ）・肢2（アⅡ─ウⅢ）・肢4（ウⅡ─オⅡ）・肢5（エⅡ─オⅢ）はいずれも誤った結論を含む。肢3のみが <strong>イⅢ・エⅢ という正しい組合せ</strong>を提示する。<a class="ref-stat" id="ref-law-246-019" href="#law-246">246条</a>詐欺罪の構成要件理解＋<a class="ref-stat" id="ref-law-247-007" href="#law-247">247条</a>・<a class="ref-stat" id="ref-law-249-006" href="#law-249">249条</a>・<a class="ref-stat" id="ref-law-253-007" href="#law-253">253条</a>・<a class="ref-stat" id="ref-law-109-006" href="#law-109">109条2項</a>・<a class="ref-stat" id="ref-law-148-013" href="#law-148">148条2項</a>等の隣接罪の体系的理解で確実に到達できる<strong>詐欺罪と他罪の成否</strong>の標準問題。正答率65%はやや高めで、5 記述それぞれの判例知識を網羅的に持っていることが要求される。</p>
    </div>
  ...
  <section class="section recall-arena" id="part-d">
    ...
    <p class="arena-intro">
      PART Bの5 記述・5 判例を、12 問の即答ドリルで一気に固める。<strong>判例の射程と核心法理</strong>の即答化を狙う。各記述につき2 問（誤判断パターン＋正判断確認）＋横断2 問の構成。
    </p>
    ...
    <!-- DRILL 01: 記述ア（誤判断パターン ×） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;01</span>
        <span class="drill-tag">記述ア / 詐欺と背任の包含関係</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="×"
           data-explanation="×。最判昭28.5.8は背任行為が詐欺の観念に当然包含されるとし、別個に背任罪は成立しないとする（詐欺罪のみ成立＝結論Ⅰ）。両罪併存・観念的競合（結論Ⅱ）ではない。">
        <div class="quiz-question">Q. 他人のためにその事務を処理する者が任務に背いて欺罔行為をし、相手を錯誤に陥らせて財物を交付させた場合、判例によれば詐欺罪と背任罪の双方が成立する。</div>
        ...
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例（最判昭28.5.8）は背任を詐欺に「包含」させ詐欺罪のみ成立とする。結論Ⅰ。<a class="drill-back" href="#choice-1">→ 記述アの解説</a>
        </div>
      </div>
    </div>
    ...
    <div class="drill-block">
      <div class="drill-label">
        ...
        <span class="drill-tag">記述ア / 包含理論の論拠</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="○"
           data-explanation="○。判例の論拠は「背任行為は詐欺罪の観念に当然包含される」。法定刑も詐欺罪（10年以下）の方が背任罪（5年以下）より重く、立法者意思としても詐欺罪が背任罪を吸収する関係。">
        <div class="quiz-question">Q. 判例によれば、背任的欺罔行為は「詐欺罪の観念に当然包含される」ため、詐欺罪のみが成立し、別個に背任罪は成立しない。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="true" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="false" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例（最判昭28.5.8）の核心法理。法条競合（吸収関係）。<a class="drill-back" href="#choice-1">→ 記述アの解説</a>
        </div>
      </div>
    </div>

    <!-- DRILL 03: 記述イ（誤判断パターン ×・本問正解の一部） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;03</span>
        <span class="drill-tag">記述イ / 究極原因論</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="×"
           data-explanation="×。最判昭24.2.8は、虚偽部分が畏怖の一材料に過ぎず究極的原因は畏怖と評価し、恐喝罪のみが成立し詐欺罪は不成立とする。形式的に欺罔が並存するように見えても、判例は罪名を一義的に決する。これが本問正解の一部（結論Ⅲ）。">
        <div class="quiz-question">Q. 恐喝の脅迫文言中に虚偽部分が混在し、その虚偽部分が畏怖の一材料となって財物が交付された場合、判例によれば詐欺罪と恐喝罪の双方が成立する。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="false" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="true" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例（最判昭24.2.8）の究極原因論。畏怖が主、虚偽は従。恐喝罪のみ成立＝結論Ⅲ。<a class="drill-back" href="#choice-2">→ 記述イの解説</a>
        </div>
      </div>
    </div>
    ...
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;04</span>
        <span class="drill-tag">記述イ / 究極原因論の論拠</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="○"
           data-explanation="○。判例（最判昭24.2.8）は、虚偽部分を畏怖の一材料と位置付け、究極的には恐喝による畏怖の結果として財物が交付されたと評価する。罪名は畏怖の方で一義的に決する。">
        <div class="quiz-question">Q. 判例によれば、脅迫文言中の虚偽部分は「畏怖の一材料」に過ぎず、究極的原因は畏怖であるため、恐喝罪のみ成立し詐欺罪は不成立となる。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="true" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="false" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例の確立法理。両罪併存ではなく一方に決する。<a class="drill-back" href="#choice-2">→ 記述イの解説</a>
        </div>
      </div>
    </div>

    <!-- DRILL 05: 記述ウ（誤判断パターン ×） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;05</span>
        <span class="drill-tag">記述ウ / 集金員の不法意図</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="×"
           data-explanation="×。東京高判昭28.6.12は、正規の権限者が正規の手続・方式で集金する行為自体は適法であり、内心の不法意図は「動機の不法」に過ぎず集金行為を違法ならしめないとする。よって購読者に対する詐欺罪は成立しない。事後の費消が業務上横領罪を構成。">
        <div class="quiz-question">Q. 新聞販売店から集金業務を委託された集金員が、集金後に自分で費消するつもりであることを秘して正規の手続で購読者から購読料を集金した場合、購読者に対する詐欺罪が成立する。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="false" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="true" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>正規集金は適法。動機の不法は欺罔行為を構成しない。事後の費消が業務上横領罪。<a class="drill-back" href="#choice-3">→ 記述ウの解説</a>
        </div>
      </div>
    </div>
    ...
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;06</span>
        <span class="drill-tag">記述ウ / 動機の不法と業務上横領</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="○"
           data-explanation="○。集金員の不法意図は集金行為そのものを違法ならしめず、購読者への欺罔行為とならない。よって詐欺罪不成立。集金後の費消行為が、業務上自己の占有する他人（販売店）の物を領得する業務上横領罪を構成する。">
        <div class="quiz-question">Q. 判例によれば、正規集金員が「集金後に費消するつもり」を秘して集金する行為は、購読者に対する詐欺罪を構成せず、集金後の費消行為が業務上横領罪を構成する。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="true" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="false" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例（東京高判昭28.6.12）の確立法理。占有取得は適法、事後の領得が横領。<a class="drill-back" href="#choice-3">→ 記述ウの解説</a>
        </div>
      </div>
    </div>

    <!-- DRILL 07: 記述エ（誤判断パターン ×・本問正解の一部） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;07</span>
        <span class="drill-tag">記述エ / 詐欺罪の実行着手</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="×"
           data-explanation="×。大判明5.12.12は、保険金詐取目的の放火だけでは人に対する欺罔行為がなく詐欺罪の実行着手とはいえないとする。保険会社への保険金請求の段階で初めて着手が認められる。よって放火段階では詐欺罪不成立（結論Ⅲ・本問正解の一部）。">
        <div class="quiz-question">Q. 保険金を詐取する目的で火災保険の付された自己所有の家屋に放火した時点で、判例によれば詐欺罪の実行に着手したものといえる。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="false" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="true" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例（大判明5.12.12）は欺罔行為開始説。放火段階では「人」への欺罔がない。<a class="drill-back" href="#choice-4">→ 記述エの解説</a>
        </div>
      </div>
    </div>
    ...
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;08</span>
        <span class="drill-tag">記述エ / 着手の客観的基準</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="○"
           data-explanation="○。判例の立場では、詐欺罪の実行の着手は「行為者が詐欺の意思で人に対し欺罔行為を開始したとき」。保険会社に対する保険金請求が始まる時点で初めて欺罔行為の開始＝実行の着手と評価される。">
        <div class="quiz-question">Q. 判例によれば、保険金詐取目的の放火事例で詐欺罪の実行の着手が認められるのは、放火後に保険会社に対する保険金請求の手続を開始した時点である。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="true" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="false" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>欺罔行為開始説。客観的構成要件該当行為の開始が着手。<a class="drill-back" href="#choice-4">→ 記述エの解説</a>
        </div>
      </div>
    </div>

    <!-- DRILL 09: 記述オ（誤判断パターン ×） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;09</span>
        <span class="drill-tag">記述オ / 偽造通貨行使と詐欺</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="×"
           data-explanation="×。大判明43.6.30は、偽造通貨を行使して財物を不正領得した場合、財物領得行為は偽造通貨行使罪に包含され、別個に詐欺罪は成立しないとする。論拠は ①通貨の本来的支払手段性、②152条収得後知情行使罪との均衡。">
        <div class="quiz-question">Q. 他人に売買代金として偽造通貨を行使して相手を錯誤に陥らせ財物を交付させた場合、判例によれば偽造通貨行使罪と詐欺罪の双方が成立する。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="false" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="true" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>判例（大判明43.6.30）は法条競合（吸収）。偽造通貨行使罪のみ。152条均衡論が決定的論拠。<a class="drill-back" href="#choice-5">→ 記述オの解説</a>
        </div>
      </div>
    </div>
    ...
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;10</span>
        <span class="drill-tag">記述オ / 152条均衡論</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="○"
           data-explanation="○。判例の決定的論拠は152条（収得後知情行使罪）との均衡。152条は罰金・科料で軽い処罰だが、ここに詐欺罪を併存させると152条の軽処罰立法趣旨が没却される。よって148条2項においても詐欺罪併存を否定して整合性を確保する。">
        <div class="quiz-question">Q. 判例が偽造通貨行使罪に詐欺罪を併存させない論拠の一つは、152条収得後知情行使罪との均衡（152条にも詐欺罪を併存させれば軽処罰の立法趣旨が没却される）にある。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="true" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="false" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>152条均衡論──下位条文との整合性から上位条文の解釈を導く判例論理。<a class="drill-back" href="#choice-5">→ 記述オの解説</a>
        </div>
      </div>
    </div>

    <!-- DRILL 11: 横断問題1（実行着手論の射程） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;11</span>
        <span class="drill-tag">Cross / 実行着手論の汎用性</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="○"
           data-explanation="○。判例（大判明5.12.12）の「人に対する欺罔行為の開始」基準は古典的事案だが、現代の特殊詐欺（オレオレ詐欺等）の着手時期判断にも応用されている（最決平16.3.22）。架け子の電話が欺罔行為の開始時として実行の着手と評価される。">
        <div class="quiz-question">Q. 詐欺罪の実行着手時期に関する判例の基準（「人に対する欺罔行為の開始」）は、保険金詐取目的の放火だけでなく、現代の特殊詐欺（オレオレ詐欺等）における架け子の電話の着手判断にも応用される。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="true" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="false" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>古典判例の射程は現代事案にも及ぶ。実行着手論の汎用性を確認する横断論点。<a class="drill-back" href="#c-3">→ C-3 実行着手論</a>
        </div>
      </div>
    </div>

    <!-- DRILL 12: 横断問題2（罪数論──包含関係の方向性） -->
    <div class="drill-block">
      <div class="drill-label">
        <span class="drill-num">DRILL&nbsp;12</span>
        <span class="drill-tag">Cross / 罪数論・包含関係の方向</span>
      </div>
      <div class="self-check-quiz" data-arena="1"
           data-correct-value="×"
           data-explanation="×。記述アは詐欺罪が背任罪を包含するため詐欺罪のみ成立（結論Ⅰ）。記述オは詐欺罪が偽造通貨行使罪に包含されるため偽造通貨行使罪のみ成立（結論Ⅲ）。両者で「包含する／される」の方向が逆になる。法定刑の重さ（詐欺10年≧背任5年 vs 偽造通貨行使無期≧詐欺10年）と立法者意思から方向が決まる。">
        <div class="quiz-question">Q. 詐欺罪と他罪の罪数関係において、記述ア（詐欺と背任）も記述オ（詐欺と偽造通貨行使）も、いずれも詐欺罪が他罪を包含する関係にある。</div>
        <div class="quiz-buttons">
          <button class="quiz-btn" type="button" data-correct="false" data-value="○">○</button>
          <button class="quiz-btn" type="button" data-correct="true" data-value="×">×</button>
        </div>
        <div class="quiz-answer" hidden>
          <span class="quiz-result"></span>包含の方向は逆。ア=詐欺が包含する（Ⅰ）／オ=詐欺が包含される（Ⅲ）。法定刑の重さで判断。<a class="drill-back" href="#c-4">→ C-4 学説対立</a>
        </div>
      </div>
    </div>
  ...
  <!-- ============================================================
       ...
       ============================================================ -->
  <div class="footer-spec">
    <strong>KTX301</strong> ── 詐欺罪と他罪の成否（刑法R1-16） ／ Pattern P1 ローズシャンブル ／ 正答率 65% ／ <strong>TX v8.7</strong> ／ <span style="font-family:var(--font-mono);font-size:.85em;color:rgba(255,255,255,.78);letter-spacing:.08em;">choice-points · ref-stat · ref-case · ref-backlinks · spoiler-block · 3-tier-fa · db-blr-clean · kp-impact · rb-chip-tan · ktx296-canon</span>
  </div>
...
## §Annex C. Canonical JS（KTX301 byte-level 逐語）
...
(function(){
  ...
  // ========================================================
  // A-2 標準型（answer-slot）— v8.1: fb-verdict / fb-answer 分離
  // ========================================================
  ...
  // ========================================================
  // A-2 互換型（choice-row + check-btn）— v8.1
  // ========================================================
...
> **TX v8.11.7 完全統合自己完結仕様書（KTX301-canonical · readability-enhanced · hanging-indent-grid · lessons-from-chat-002 · single-document-self-sufficient · jp-prefix-naming · content-independence · a2-two-stage-reveal · 3-type-support · spoiler-leak-eradication · spoiler-strong-elimination · ox-grid-fa-unification · host-injection-safe）終わり**
>
> **使用方法（再掲）**:
>
> 1. **新規 TX ファイル生成**：本仕様書全文＋問題 PDF を AI に送信 → §0-tri 6 ステップ → §0-quad 7 ステップ独立性プロトコル → §0-bis 15 ステップ → §1-bis 命名規則 → §17 3 Type 対応（single/multi/ox-grid 自動判定）→ §31 S1〜S82 自己検証通過後に配信。**追加の仕様書・参照ファイルは一切不要**（自己完結）
>
> 2. **既存 TX ファイル（v8.10.2 以下）アップグレード**：§0-tri STEP 1（既存スタイル完全破棄・v8.11.x 拡張版）を最優先実行 → §35 K302-1〜K302-17 異常検出 → §34-bis 12 ステップで v8.11.0 canonical 化 → §34-quater〜§34-novies の minor 更新ルートを順次適用（v8.11.0 → v8.11.7 への段階的移行）→ S64〜S82 検証
>
> 3. **段階的 minor update**：旧バージョン別の最短ルート：
>    - v8.11.1 → v8.11.7：§34-quater〜§34-novies を順次（5 ステップ × 6 段）
>    - v8.11.5/v8.11.6 → v8.11.7：§34-octies（hotfix1）＋ §34-novies の 5 ステップのみ
>    - v8.11.6-hotfix1 → v8.11.7：§34-novies の 3 ステップのみ（ファイル ID・命名・出力先の整備）
>
> 4. **改変ソース反映**：内容変更箇所のみ波及修正 → 事前事後検証＋ S52〜S82
>
> **v8.11.7 で確立した経路**：(a) KTX301 を新正典として canonical 化（v8.11.0 継承）、(b) chat-002 の試行錯誤を AP-26〜AP-29 / S64〜S67 で恒久教訓化（継承）、(c) §24 readability layer を canonical 規範化（継承）、(d) §Annex A/B/C 全文を本仕様書に埋込み一元化（継承）、(e) §1-bis 日本語接頭辞 + TX 命名規則の正式化（v8.11.1 継承）、(f) §0-quad コンテンツ独立性プロトコルで canonical text leakage を恒久遮断（v8.11.1 継承）、(g) **A-2 2 段階開示プロトコル＋ 3 Type 対応で自答→確認→詳細学習サイクルの厳格分離**（v8.11.2/3 統合）、(h) **spoiler-leak-eradication ／ spoiler-strong-elimination ／ ox-grid-fa-unification でネタバレ完全排除**（v8.11.4/5 統合）、(i) **host-injection-safe で Lexia 等 host アプリの正規表現バグから保護**（v8.11.6-hotfix1 統合）、の 9 層で「user-driven evolution」「自動生成環境の運用安定性」「学習サイクルの厳密性」「ホスト環境互換性」を両立する経路を確立した。
>
