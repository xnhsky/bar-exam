...
| `jx-ariadne-v1.2.0-core.md` | ARIADNE 現行（v1.2.0 PLACEHOLDER-LOCK）解法ナビ＋答案構成周回正典 |
| `jx-ariadne-v1.1.0-core.md` | ARIADNE 旧 active（v1.1.0 MATRIX-THREAD）。v1.2 が継承する見た目合意・恒久対策 |
