...
設計ソース = outputs/004_JX_EX/ARIADNE/001_刑法/刑JX001_ARIADNE.html（手作業で完成済み）。
...
SRC = ROOT / "outputs/004_JX_EX/ARIADNE/001_刑法/刑JX001_ARIADNE.html"
...
TARGETS = {
    "outputs/004_JX_EX/ARIADNE/001_刑法/刑JX025_ARIADNE.html":
        ("HARD", "刑JX025＝強盗予備・共犯関係からの離脱・予備の共同正犯＝難論点"),
    "outputs/004_JX_EX/ARIADNE/001_刑法/刑JX026_ARIADNE.html":
        ("STD", "刑JX026＝正当防衛の急迫性・共同正犯と正当防衛＝頻出・中堅"),
    "outputs/004_JX_EX/ARIADNE/001_刑法/刑JX027_ARIADNE.html":
        ("STD", "刑JX027＝過失の共同正犯・業務上過失致傷＝応用・中堅"),
    "outputs/004_JX_EX/ARIADNE/001_刑法/刑JX028_ARIADNE.html":
        ("HARD", "刑JX028＝原因において自由な行為・不作為による幇助＝難論点重畳"),
    "outputs/004_JX_EX/ARIADNE/001_刑法/刑JX029_ARIADNE.html":
