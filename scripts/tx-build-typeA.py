...
.fa-narrative > p[data-fa-label]::before{ content:attr(data-fa-label); position:absolute; top:-12px; left:13px;
  display:inline-flex; align-items:center; justify-content:center; box-sizing:border-box; padding:3px 11px; text-align:center; text-indent:0;
  color:#fff; background:linear-gradient(180deg,#c8843a,#a8692a); border:1.5px solid rgba(255,255,255,.72);
  border-radius:999px; box-shadow:0 1px 3px rgba(120,80,20,.35); font-size:11.5px; font-weight:800; line-height:1;
