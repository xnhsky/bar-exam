...
.athena-graft .judgment-text strong{background:linear-gradient(transparent 58%,rgba(174,213,129,.55) 58%); font-weight:700; color:inherit}
...
/* 学説対立 gakusetsu 採用説＝緑（TX_lex hl-high 系）*/
