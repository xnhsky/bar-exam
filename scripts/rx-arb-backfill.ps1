...
#   RX      = 論証カード（1論点1HTML / outputs/ux/002_RX/{00N_科目}/{科目}RX{NNN}_{n}.html）
...
$RxOutputDir   = Join-Path $ProjectRoot "outputs\ux\002_RX\$SubjDir"
$ArbOutputDir  = Join-Path $ProjectRoot "outputs\ux\003_TREE\$SubjDir"
$AriadneOutputDir = Join-Path $ProjectRoot "outputs\ux\001_ARIADNE\$SubjDir"
