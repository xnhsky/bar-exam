...
Usage:
  python scripts/migrate-tts-sequential.py outputs/tts            # dry-run（全フォルダ）
  python scripts/migrate-tts-sequential.py outputs/tts --apply    # 実行（git mv + 内容書換）
  python scripts/migrate-tts-sequential.py outputs/tts/刑JX029 --apply  # 単一フォルダ
