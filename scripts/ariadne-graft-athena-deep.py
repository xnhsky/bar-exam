...
.athena-graft{margin:10px 0 2px; --gc:#fff; --gch:#f3f4f6; --gcd:var(--a-head)}
.athena-graft section[id^="ref-stat"]{--gc:var(--ml-blue); --gch:var(--ml-blue-b); --gcd:var(--ml-blue-d)}
.athena-graft section[id^="ref-case"]{--gc:var(--ml-pink); --gch:var(--ml-pink-b); --gcd:var(--ml-pink-d)}
.athena-graft section[id^="ref-doctrine"]{--gc:var(--ml-green); --gch:var(--ml-green-b); --gcd:var(--ml-green-d)}
.athena-graft section[id^="ref-term"]{--gc:var(--ml-yellow); --gch:var(--ml-yellow-b); --gcd:var(--ml-yellow-d)}
...
.athena-graft .card,.athena-graft .ref-entry{background:var(--gc); border:1px solid var(--gch); border-left:5px solid var(--gcd); border-radius:10px; padding:0 19px 16px; margin:14px 0; overflow:hidden; box-shadow:0 2px 8px rgba(70,58,80,.07); font-family:var(--f-body); font-size:.9rem; line-height:1.92; color:#2f2935}

/* カードヘッダ ＝ TX .basis-card-header（型別淡色帯・明朝） */
.athena-graft .ref-entry > h4{font-family:var(--f-disp); font-weight:700; font-size:1.05em; color:#2c2632; letter-spacing:.03em; margin:0 -19px 14px; padding:12px 19px; background:var(--gch); border-bottom:1.5px solid rgba(0,0,0,.10); display:flex; align-items:center; gap:9px; flex-wrap:wrap}
...
.athena-graft blockquote.statute{margin:8px 0 12px; padding:12px 16px; border-radius:8px; font-family:var(--f-disp); font-size:.95rem; line-height:1.95; color:#2f2935; background:rgba(255,255,255,.72); border:1px solid var(--gch); border-left:4px solid var(--gcd)}
...
.athena-graft th{background:var(--gcd); color:#fff; font-family:var(--f-soft); font-weight:700; letter-spacing:.04em; white-space:nowrap}
