...
.athena-graft .card,.athena-graft .ref-entry{background:#fff; border:1px solid #e3dce8; border-left:5px solid #8e6e9a; border-radius:10px; padding:0 19px 16px; margin:14px 0; overflow:hidden; box-shadow:0 2px 8px rgba(70,58,80,.07); font-family:var(--f-body); font-size:.9rem; line-height:1.92; color:#2f2935}
