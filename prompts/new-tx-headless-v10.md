...
| `{OUTPUT_PATH}` | `C:\Users\xnh\bar-exam\outputs\000_TX\刑TX\刑TX312.html` | 出力 HTML の絶対パス |
...
| 科目 | 接頭辞 | 出力先 |
|---|---|---|
| 刑法 | `刑TX` | `outputs/000_TX/刑TX/刑TX{NNN}.html` |
| 憲法 | `憲TX` | `outputs/000_TX/憲TX/憲TX{NNN}.html` |
| 民法 | `民TX` | `outputs/000_TX/民TX/民TX{NNN}.html` |
| 商法 | `商TX` | `outputs/000_TX/商TX/商TX{NNN}.html` |
| 民訴 | `民訴TX` | `outputs/000_TX/民訴TX/民訴TX{NNN}.html` |
| 刑訴 | `刑訴TX` | `outputs/000_TX/刑訴TX/刑訴TX{NNN}.html` |
| 行政法 | `行政TX` | `outputs/000_TX/行政TX/行政TX{NNN}.html` |
