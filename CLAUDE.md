...
| コマンド | 用途 |
|---|---|
| `/new-tx <PDFパス>` | 新規 TX を問題 PDF から生成（**v11.1.0 LOOP-CORE ＋二系統出力**：公式 `000_TX`＝本物5択／Lexia 用 `ux/000_TX/..._lex`＝ox-grid＋解法ナビ。GENESIS-CORE＋`canonical/SOLVE-NAV.html`・validate-tx-core を両ファイル） |
