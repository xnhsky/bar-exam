...
|---|---|---|---|
| **TX** | 短答式（5択・○×・組合せ）の単問解説 HTML | **v12.2.1 LOOP-CORE**：`canonical/GENESIS-CORE.html`＋`GENESIS-DEEP.html`／`spec/tx-v12.1.0-inline-core.md`＋`docs/tx-v12.2.1-inline-lock.md` | 1 問 = 公式＋Lexia `_lex`（別冊は必要時） |
...
| コマンド | 用途 |
|---|---|
| `/new-tx <PDFパス>` | 新規 TX を問題 PDF から生成（**v12.2.1 LOOP-CORE ＋二系統出力**：公式 `000_TX`＝本物5択／Lexia 用 `ux/000_TX/..._lex`＝インライン肢カード＋ox-grid＋解法ナビ。GENESIS-CORE＋`canonical/SOLVE-NAV.html`・G45 を含む validate-tx-core） |
