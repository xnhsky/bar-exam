...
| コマンド | 用途 |
|---|---|
| `/new-tx <PDFパス>` | 新規 TX を問題 PDF から生成（**_lex＝v13.1.0 LOOP-CARD ＋二系統出力**：公式 `000_TX`＝本物5択／Lexia 用 `ux/000_TX/..._lex`＝v13 記述カード＋ox-grid＋解法ナビ。GENESIS-CARD＋`canonical/SOLVE-NAV.html`・G1〜G62 の validate-tx-core・共有事例型は §v13n 不可侵原文ブロック） |
