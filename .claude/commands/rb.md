---
description: RB（リモートバッチ）— inputs/tx-pdfs の「N番からM番まで」をリモートで連続バッチ生成し、各問完了ごとに git commit/push で永続化する。「346-350 を RB して」「RB 346〜350」等で起動。
---
...
v10.0.0-gold-skeleton 規律そのままで連続生成し、**各問の検証通過ごとに git commit/push**
