...
1. `spec/tx-v8.11.6-core.md` を view（規律確認）
2. `spec/tx-v8.11.6-annex-A.css` 全文を新 `<style>` 内に逐語コピー
3. パターン判定し、P2/P3 なら対応する annex-A-bis を末尾追記
4. `spec/tx-v8.11.6-annex-B.html` の skeleton 構造に整合
5. **A-3 共通根拠 section を PART B 後ろ・PART C 前に再配置**
6. `spec/tx-v8.11.6-annex-C.js` 全文を逐語コピー
