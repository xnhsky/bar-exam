...
> - 唯一の起点は `canonical/GENESIS-CORE.html`（v11.1.0）。validate は `scripts/validate-tx-core.py`（G1〜G33）。
...
15. **G1〜G33 ERROR 0 件確認**（特に G20 記述単位・G21 禁止句・G22 choice-points・G23 answer-key（_lex）・
