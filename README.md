...
│       └── validate.md
├── spec/                         # 仕様書（読み取り専用扱い）
│   ├── tx-v8.11.7-core.md        # TX 仕様書（自己完結・5400 行）
...
| **仕様書** | tx-v8.11.7-core.md | jx-v3.2-master.md |
| **設計思想** | KTX301 を構造正典とする canonical 移行モデル | 三層ペルソナ（法学教育者・認知心理エディトリアル・色彩設計） |
...
詳しくは `spec/tx-v8.11.7-core.md` の §0-prime（v8.11.1 → v8.11.7 統合差分）と §36（v8.11.7 設計総括）を参照。
